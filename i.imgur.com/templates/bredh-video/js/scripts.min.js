function scrollToGatewayInputError() {
    ...
    e.find('button[type="submit"],input[type="submit"]').prop("disabled", !1).removeClass("disabled").find("i.fas,i.far,i.fal,i.fab").removeAttr("class").addClass("fas fa-arrow-circle-right").find("span").toggleClass("hidden"),
...
function checkAll(t, e) {
    ...
    jQuery(e).is(":checked") && jQuery(t).click()
}
...
function popupWindow(t, e, n, i, r) {
    ...
    s += "left=" + o + ",",
    s += r,
    win = window.open(t, e, s),
    win.window.focus()
}
function addRenewalToCart(t, e) {
    jQuery("#domainRow" + t).attr("disabled", "disabled"),
    jQuery("#domainRow" + t).find("select,button").attr("disabled", "disabled"),
    ...
    WHMCS.http.jqClient.post("clientarea.php", "addRenewalToCart=1&token=" + csrfToken + "&renewID=" + t + "&period=" + n, function(t) {
        jQuery("#cartItemCount").html(1 * jQuery("#cartItemCount").html() + 1),
        jQuery(e).html('<span class="glyphicon glyphicon-shopping-cart"></span> Added'),
...
function getticketsuggestions() {
    ...
    currentcheckcontent != lastcheckcontent && "" != currentcheckcontent && (WHMCS.http.jqClient.post("submitticket.php", {
        action: "getkbarticles",
        text: currentcheckcontent
    }, function(t) {
        t && (jQuery("#searchresults").html(t),
...
function useDefaultWhois(t) {
    jQuery("." + t.substr(0, t.length - 1) + "customwhois").attr("disabled", !0),
    jQuery("." + t.substr(0, t.length - 1) + "defaultwhois").attr("disabled", !1),
    jQuery("#" + t.substr(0, t.length - 1) + "1").attr("checked", "checked")
}
function useCustomWhois(t) {
    jQuery("." + t.substr(0, t.length - 1) + "customwhois").attr("disabled", !1),
    jQuery("." + t.substr(0, t.length - 1) + "defaultwhois").attr("disabled", !0),
...
function showNewCardInputFields() {
    ...
    jQuery("#billingAddressChoice").slideDown().find('input[name="billingcontact"]').first().iCheck("check")
}
function showNewAccountInputFields() {
    jQuery(".bank-details").hasClass("hidden") && jQuery(".bank-details").hide().removeClass("hidden"),
...
function hideNewCardInputFields() {
    ...
    n.length && (jQuery(".billing-contact-info").hide(),
    jQuery(n).show())
}
...
function getTicketSuggestions() {
    ...
    t != lastTicketMsg && "" != t && (WHMCS.http.jqClient.post("submitticket.php", {
        ...
        t && (jQuery("#autoAnswerSuggestions").html(t),
        jQuery("#autoAnswerSuggestions").is(":visible") || jQuery("#autoAnswerSuggestions").hide().removeClass("hidden").slideDown())
    }),
    lastTicketMsg = t),
    setTimeout("getTicketSuggestions()", 3e3)
}
...
function showOverlay(t) {
    jQuery("#fullpage-overlay .msg").html(t),
...
function openModal(t, e, n, i, r, o, a, s, d) {
    ...
    a) {
        var l = jQuery("#" + a);
        l.off("click"),
        l.on("click", submitIdAjaxModalClickEvent)
    }
}
function submitIdAjaxModalClickEvent() {
    if (!jQuery(this).hasClass("disabled")) {
        var t = !0
          , e = jQuery(this);
        if (e.addClass("disabled"),
        jQuery("#modalAjax .loader").show(),
        ajaxModalSubmitEvents.length && jQuery.each(ajaxModalSubmitEvents, function(e, n) {
            var i = window[n];
            t && "function" == typeof i && (t = i())
        }),
        !t)
            return e.removeClass("disabled"),
            void jQuery("#modalAjax .loader").hide();
        ...
        WHMCS.http.jqClient.post(n.attr("action"), n.serialize(), function(t) {
            n.data("successDataTable") && (t.successDataTable = n.data("successDataTable")),
            updateAjaxModal(t)
        }, "json").fail(function(t) {
            var e = t.responseJSON
              , n = "An error occurred while communicating with the server. Please try again.";
            e && e.data ? (e = e.data,
            e.errorMsg ? r.length > 0 ? jQuery(r).html(e.errorMsg).slideDown() : jQuery.growl.warning({
                title: e.errorMsgTitle,
                message: e.errorMsg
            }) : e.data.body ? jQuery(i).html(e.body) : jQuery(i).html(n)) : jQuery(i).html(n),
            jQuery("#modalAjax .loader").fadeOut()
        }).always(function() {
...
function updateAjaxModal(t) {
    if (t.reloadPage)
        return void ("string" == typeof t.reloadPage ? window.location = t.reloadPage : window.location.reload());
    ...
    dialogClose()),
    t.successWindow && "function" == typeof window[t.successWindow] && window[t.successWindow](),
    t.dismiss && dialogClose(),
    t.successMsg && jQuery.growl.notice({
    ...
    if (t.title && jQuery("#modalAjax .modal-title").html(t.title),
    t.body ? jQuery("#modalAjax .modal-body").html(t.body) : t.url && WHMCS.http.jqClient.post(t.url, "", function(t) {
    ...
    t.submitId) {
        ...
        n.off("click"),
        n.on("click", submitIdAjaxModalClickEvent)
    }
    jQuery("#modalAjax .loader").fadeOut(),
...
if (function(t, e) {
    ...
    function u(t, e, n, i) {
        if (Lt(t)) {
            ...
            if (l && d[l] && (i || d[l].data) || void 0 !== n || "string" != typeof e)
                ...
                i || (o.data || (o.data = {}),
                o = o.data),
                void 0 !== n && (o[pt.camelCase(e)] = n),
                "string" == typeof e ? (r = o[e],
                null == r && (r = o[pt.camelCase(e)])) : r = o,
                r
        }
    }
    function c(t, e, n) {
        if (Lt(t)) {
            ...
            if (a[s]) {
                ...
                (n || (delete a[s].data,
                l(a[s]))) && (o ? pt.cleanData([t], !0) : ct.deleteExpando || a != a.window ? delete a[s] : a[s] = void 0)
            }
        }
    }
    function h(t, e, n, i) {
        ...
        , d = s(), l = n && n[3] || (pt.cssNumber[e] ? "" : "px"), u = (pt.cssNumber[e] || "px" !== l && +d) && Pt.exec(pt.css(t, e));
        if (u && u[3] !== l) {
            l = l || u[3],
            n = n || [],
            u = +d || 1;
    ...
    function f(t, e) {
        ...
        if (!o)
            ...
            n = t.childNodes || t; null != (i = n[r]); r++)
                !e || pt.nodeName(i, e) ? o.push(i) : pt.merge(o, f(i, e));
    ...
    function $(t, e, n, i, r) {
        for (var o, a, s, d, l, u, c, h = t.length, $ = p(e), v = [], y = 0; y < h; y++)
            ...
            a || 0 === a)
                if ("object" === pt.type(a))
                    pt.merge(v, a.nodeType ? [a] : a);
                else if (zt.test(a)) {
                    for (d = d || $.appendChild(e.createElement("div")),
                    l = (Qt.exec(a) || ["", ""])[1].toLowerCase(),
                    c = qt[l] || qt._default,
                    d.innerHTML = c[1] + pt.htmlPrefilter(a) + c[2],
                    o = c[0]; o--; )
                        d = d.lastChild;
                    if (!ct.leadingWhitespace && Wt.test(a) && v.push(e.createTextNode(Wt.exec(a)[0])),
                    !ct.tbody)
                        for (a = "table" !== l || Gt.test(a) ? "<table>" !== c[1] || Gt.test(a) ? 0 : d : d.firstChild,
                        o = a && a.childNodes.length; o--; )
                            pt.nodeName(u = a.childNodes[o], "tbody") && !u.childNodes.length && a.removeChild(u);
                    for (pt.merge(v, d.childNodes),
                    d.textContent = ""; d.firstChild; )
                        d.removeChild(d.firstChild);
                    d = $.lastChild
                } else
                    v.push(e.createTextNode(a));
        for (d && $.removeChild(d),
        ct.appendChecked || pt.grep(f(v, "input"), m),
        y = 0; a = v[y++]; )
            if (i && pt.inArray(a, i) > -1)
                r && r.push(a);
            else if (s = pt.contains(a.ownerDocument, a),
            d = f($.appendChild(a), "script"),
            s && g(d),
            n)
                for (o = 0; a = d[o++]; )
                    Bt.test(a.type || "") && n.push(a);
        return d = null,
        $
    }
    function v() {
    ...
    function k(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            !ct.noCloneEvent && e[pt.expando]) {
                r = pt._data(e);
                for (i in r.events)
                    pt.removeEvent(e, i, r.handle);
                e.removeAttribute(pt.expando)
            }
            "script" === n && e.text !== t.text ? (x(e).text = t.text,
            S(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML),
            ct.html5Clone && t.innerHTML && !pt.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && Ft.test(t.type) ? (e.defaultChecked = e.checked = t.checked,
    ...
    function _(t, e, n, i) {
        ...
        if (g || c > 1 && "string" == typeof p && !ct.checkClone && ie.test(p))
            return t.each(function(r) {
                var o = t.eq(r);
                g && (e[0] = p.call(this, r, o.html())),
                _(o, e, n, i)
            });
        if (c && (l = $(e, t[0].ownerDocument, !1, t, i),
        r = l.firstChild,
        1 === l.childNodes.length && (l = r),
        r || i)) {
            for (s = pt.map(f(l, "script"), x),
            a = s.length; u < c; u++)
                o = l,
                u !== h && (o = pt.clone(o, !0, !0),
                a && pt.merge(s, f(o, "script"))),
                n.call(t[u], o, u);
            if (a)
                ...
                u = 0; u < a; u++)
                    o = s[u],
                    Bt.test(o.type || "") && !pt._data(o, "globalEval") && pt.contains(d, o) && (o.src ? pt._evalUrl && pt._evalUrl(o.src) : pt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(oe, "")));
            l = r = null
        }
        return t
    }
    ...
    function I(t) {
        var e = it
          , n = le[t];
        return n || (n = j(t, e),
        "none" !== n && n || (de = (de || pt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
        e = (de[0].contentWindow || de[0].contentDocument).document,
        e.write(),
        e.close(),
        n = j(t, e),
        de.detach()),
    ...
    function N(t, e) {
        for (var n, i, r, o = [], a = 0, s = t.length; a < s; a++)
            i = t[a],
            i.style && (o[a] = pt._data(i, "olddisplay"),
            n = i.style.display,
            e ? (o[a] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && Ht(i) && (o[a] = pt._data(i, "olddisplay", I(i.nodeName)))) : (r = Ht(i),
    ...
    function M(t, e, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += pt.css(t, n + Rt[o], !0, r)),
            i ? ("content" === n && (a -= pt.css(t, "padding" + Rt[o], !0, r)),
            "margin" !== n && (a -= pt.css(t, "border" + Rt[o] + "Width", !0, r))) : (a += pt.css(t, "padding" + Rt[o], !0, r),
    ...
    function P(t, e, n) {
        ...
        if (r <= 0 || null == r) {
            ...
            ce.test(r))
                return r;
            i = a && (ct.boxSizingReliable() || r === t.style[e]),
            r = parseFloat(r) || 0
        }
    ...
    function Q(t, e, n) {
        ...
        l = pt.css(t, "display"),
        u = "none" === l ? pt._data(t, "olddisplay") || I(t.nodeName) : l,
        "inline" === u && "none" === pt.css(t, "float") && (ct.inlineBlockNeedsLayout && "inline" !== I(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        if (pt.isEmptyObject(h))
            "inline" === ("none" === l ? I(t.nodeName) : l) && (p.display = l);
        else {
    ...
    function W(t, e, n) {
        var i, r, o = 0, a = W.prefilters.length, s = pt.Deferred().always(function() {
            ...
            if (r)
                return !1;
            for (var e = Te || H(), n = Math.max(0, l.startTime + l.duration - e), i = n / l.duration || 0, o = 1 - i, a = 0, d = l.tweens.length; a < d; a++)
                l.tweens[a].run(o);
            return s.notifyWith(t, [l, o, n]),
            o < 1 && d ? n : (s.resolveWith(t, [l]),
            !1)
        }, l = s.promise({
            elem: t,
            props: pt.extend({}, e),
    ...
    function V(t, e, n) {
        for (var i, r, o, a, s = t.contents, d = t.dataTypes; "*" === d[0]; )
            d.shift(),
    ...
    function K(t, e, n, i) {
        ...
        for (o = u.shift(); o; )
            ...
            !d && i && t.dataFilter && (e = t.dataFilter(e, t.dataType)),
            d = o,
            o = u.shift())
                if ("*" === o)
                    o = d;
        ...
        s--); s < d; s++)
            if (null != (r = arguments[s]))
                for (i in r)
                    ...
                    o = t && pt.isArray(t) ? t : []) : o = t && pt.isPlainObject(t) ? t : {},
                    a[i] = pt.extend(l, o, n)) : void 0 !== n && (a[i] = n));
        return a
    }
    ,
    pt.extend({
    ...
    var vt = function(t) {
        function e(t, e, n, i) {
            ...
            "string" != typeof t || !t || 1 !== g && 9 !== g && 11 !== g)
                return n;
            if (!i && ((e ? e.ownerDocument || e : F) !== L && A(e),
            e = e || L,
            E)) {
                if (11 !== g && (l = $t.exec(t)))
                    if (r = l[1]) {
                        if (9 === g) {
                            ...
                            if (a.id === r)
                                return n.push(a),
                                n
                        } else if (f && (a = f.getElementById(r)) && H(e, a) && a.id === r)
                            return n.push(a),
                            n
                    } else {
                        if (l[2])
                            ...
                            n;
                        if ((r = l[3]) && C.getElementsByClassName && e.getElementsByClassName)
                ...
                if (C.qsa && !q[t + " "] && (!M || !M.test(t))) {
                    if (1 !== g)
                        ...
                        for ((s = e.getAttribute("id")) ? s = s.replace(yt, "\\$&") : e.setAttribute("id", s = O),
                        c = T(t),
                        o = c.length,
                        d = ht.test(s) ? "#" + s : "[id='" + s + "']"; o--; )
                            c[o] = d + " " + h(c[o]);
                        p = c.join(","),
                    ...
                    if (p)
                        try {
                            return Y.apply(n, f.querySelectorAll(p)),
                            n
                        } catch (t) {} finally {
        ...
        function m(t, e, n, i, r) {
            for (var o, a = [], s = 0, d = t.length, l = null != e; s < d; s++)
        ...
        function $(t, e, n, r, o, a) {
            ...
            o && !o[O] && (o = $(o, a)),
            i(function(i, a, s, d) {
                var l, u, c, h = [], p = [], f = a.length, $ = i || g(e || "*", s.nodeType ? [s] : s, []), v = !t || !i && e ? $ : m($, h, t, s, d), y = n ? o || (i ? t : f || r) ? [] : a : v;
                if (n && n(v, y, s, d),
                r)
                    for (l = m(y, p),
                    r(l, [], s, d),
                ...
                if (i) {
                    if (o || t) {
                        ...
                        for (u = y.length; u--; )
                            (c = y[u]) && (l = o ? tt(i, c) : h[u]) > -1 && (i[l] = !(a[l] = c))
                    }
                } else
                    y = m(y === a ? y.splice(f, y.length) : y),
                    o ? o(null, a, y, d) : Y.apply(a, y)
            })
        }
        function v(t) {
        ...
        function y(t, n) {
            var r = n.length > 0
              ...
              , a = function(i, a, s, d, l) {
                var u, c, h, p = 0, f = "0", g = i && [], $ = [], v = D, y = i || o && w.find.TAG("*", l), b = Q += null == v ? 1 : Math.random() || .1, C = y.length;
                for (l && (D = a === L || a || l); f !== C && null != (u = y[f]); f++) {
                    if (o && u) {
                        for (c = 0,
                        a || u.ownerDocument === L || (A(u),
                        s = !E); h = t[c++]; )
                            if (h(u, a || L, s)) {
                                d.push(u);
                                break
                ...
                r && f !== p) {
                    ...
                    Y.apply(d, $),
                    l && !i && $.length > 0 && p + n.length > 1 && e.uniqueSort(d)
                }
                return l && (Q = b,
                D = v),
                g
        ...
        var b, C, w, x, S, T, k, _, D, j, I, A, L, N, E, M, P, R, H, O = "sizzle" + 1 * new Date, F = t.document, Q = 0, B = 0, W = n(), U = n(), q = n(), z = function(t, e) {
            return t === e && (I = !0),
            0
        }, G = 1 << 31, V = {}.hasOwnProperty, K = [], J = K.pop, X = K.push, Y = K.push, Z = K.slice, tt = function(t, e) {
        ...
        }, ft = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, mt = /^[^{]+\{\s*\[native \w/, $t = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, vt = /[+~]/, yt = /'|\\/g, bt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)","ig"), Ct = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        try {
            Y.apply(K = Z.call(F.childNodes), F.childNodes),
        ...
        A = e.setDocument = function(t) {
            ...
            N = L.documentElement,
            E = !S(L),
            (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)),
            ...
            C.getElementsByClassName = mt.test(L.getElementsByClassName),
            C.getById = r(function(t) {
                return N.appendChild(t).id = O,
            ...
            w.find.CLASS = C.getElementsByClassName && function(t, e) {
                if ("undefined" != typeof e.getElementsByClassName && E)
                    return e.getElementsByClassName(t)
            }
            ,
            P = [],
            M = [],
            (C.qsa = mt.test(L.querySelectorAll)) && (r(function(t) {
                N.appendChild(t).innerHTML = "<a id='" + O + "'></a><select id='" + O + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                t.querySelectorAll("[msallowcapture^='']").length && M.push("[*^$]=" + nt + "*(?:''|\"\")"),
                t.querySelectorAll("[selected]").length || M.push("\\[" + nt + "*(?:value|" + et + ")"),
                t.querySelectorAll("[id~=" + O + "-]").length || M.push("~="),
            ...
            H = e || mt.test(N.contains) ? function(t, e) {
            ...
            z = e ? function(t, e) {
                ...
                1 & n || !C.sortDetached && e.compareDocumentPosition(t) === n ? t === L || t.ownerDocument === F && H(F, t) ? -1 : e === L || e.ownerDocument === F && H(F, e) ? 1 : j ? tt(j, t) - tt(j, e) : 0 : 4 & n ? -1 : 1)
            }
            : function(t, e) {
                if (t === e)
                    return I = !0,
                ...
                if (!r || !o)
                    return t === L ? -1 : e === L ? 1 : r ? -1 : o ? 1 : j ? tt(j, t) - tt(j, e) : 0;
                if (r === o)
                    return a(t, e);
        ...
        e.matchesSelector = function(t, n) {
            ...
            n = n.replace(ut, "='$1']"),
            C.matchesSelector && E && !q[n + " "] && (!P || !P.test(n)) && (!M || !M.test(n)))
                try {
                    var i = R.call(t, n);
        ...
        w = e.selectors = {
            ...
            preFilter: {
                ATTR: function(t) {
                    return t[1] = t[1].replace(bt, Ct),
                    t[3] = (t[3] || t[4] || t[5] || "").replace(bt, Ct),
                    "~=" === t[2] && (t[3] = " " + t[3] + " "),
                    t.slice(0, 4)
                },
                CHILD: function(t) {
            ...
            filter: {
                ...
                CHILD: function(t, e, n, i, r) {
                    ...
                    : function(e, n, d) {
                        var l, u, c, h, p, f, g = o !== a ? "nextSibling" : "previousSibling", m = e.parentNode, $ = s && e.nodeName.toLowerCase(), v = !d && !s, y = !1;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (h = e; h = h[g]; )
                                        if (s ? h.nodeName.toLowerCase() === $ : 1 === h.nodeType)
                                            return !1;
                            ...
                            y = p),
                            y === !1)
                                for (; (h = ++p && h && h[g] || (y = p = 0) || f.pop()) && ((s ? h.nodeName.toLowerCase() !== $ : 1 !== h.nodeType) || !++y || (v && (c = h[O] || (h[O] = {}),
                                u = c[h.uniqueID] || (c[h.uniqueID] = {}),
                                u[t] = [Q, y]),
                                h !== e)); )
                                    ;
                ...
                PSEUDO: function(t, n) {
                    ...
                    return o[O] ? o(n) : o.length > 1 ? (r = [t, t, "", n],
            ...
            pseudos: {
                ...
                lang: i(function(t) {
                    ...
                    t = t.replace(bt, Ct).toLowerCase(),
                    function(e) {
                        var n;
                        do
                            if (n = E ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
        ...
        T = e.tokenize = function(t, n) {
            ...
            d = [],
            l = w.preFilter; s; ) {
                i && !(r = dt.exec(s)) || (r && (s = s.slice(r[0].length) || s),
                d.push(o = [])),
                i = !1,
                (r = lt.exec(s)) && (i = r.shift(),
                o.push({
                    value: i,
                    type: r[0].replace(st, " ")
                }),
                s = s.slice(i.length));
                for (a in w.filter)
                    !(r = pt[a].exec(s)) || l[a] && !(r = l[a](r)) || (i = r.shift(),
                    o.push({
                        value: i,
                        type: a,
                        matches: r
        ...
        _ = e.select = function(t, e, n, i) {
            ...
            1 === c.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === e.nodeType && E && w.relative[o[1].type]) {
                    if (e = (w.find.ID(a.matches[0].replace(bt, Ct), e) || [])[0],
                    !e)
                        return n;
                    l && (e = e.parentNode),
                    t = t.slice(o.shift().value.length)
                }
                for (r = pt.needsContext.test(t) ? 0 : o.length; r-- && (a = o[r],
                !w.relative[s = a.type]); )
            ...
            return (l || k(t, c))(i, e, !E, n, !e || vt.test(t) && u(e.parentNode) || e),
            n
        }
        ,
        C.sortStable = O.split("").sort(z).join("") === O,
    ...
    pt.fn.extend({
        find: function(t) {
            ...
            for (e = 0; e < r; e++)
                pt.find(t, i[e], n);
            return n = this.pushStack(r > 1 ? pt.unique(n) : n),
    ...
    var St, Tt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, kt = pt.fn.init = function(t, e, n) {
        ...
        "string" == typeof t) {
            ...
            if (i[1]) {
                ...
                wt.test(i[1]) && pt.isPlainObject(e))
                    for (i in e)
    ...
    pt.each({
        ...
        pt.fn[t] = function(n, i) {
            ...
            i && "string" == typeof i && (r = pt.filter(i, r)),
            this.length > 1 && (Dt[t] || (r = pt.uniqueSort(r)),
            _t.test(t) && (r = r.reverse())),
            this.pushStack(r)
        }
    });
    var jt = /\S+/g;
    pt.Callbacks = function(t) {
        ...
        var e, n, i, r, a = [], s = [], d = -1, l = function() {
            for (r = t.once,
            i = e = !0; s.length; d = -1)
                for (n = s.shift(); ++d < a.length; )
                    a[d].apply(n[0], n[1]) === !1 && t.stopOnFalse && (d = a.length,
                    n = !1);
            t.memory || (n = !1),
            e = !1,
            r && (a = n ? [] : "")
        ...
        when: function(t) {
            var e, n, i, r = 0, o = rt.call(arguments), a = o.length, s = 1 !== a || t && pt.isFunction(t.promise) ? a : 0, d = 1 === s ? t : pt.Deferred(), l = function(t, n, i) {
                return function(r) {
                    ...
                    i === e ? d.notifyWith(n, i) : --s || d.resolveWith(n, i)
                }
            };
            if (a > 1)
                for (e = new Array(a),
                n = new Array(a),
                i = new Array(a); r < a; r++)
                    o[r] && pt.isFunction(o[r].promise) ? o[r].promise().progress(l(r, n, e)).done(l(r, i, o)).fail(d.reject) : --s;
            return s || d.resolveWith(i, o),
            d.promise()
        }
    });
    var It;
    ...
    pt.extend({
        ...
        ready: function(t) {
            ...
            t !== !0 && --pt.readyWait > 0 || (It.resolveWith(it, [pt]),
    ...
    !function() {
        ...
        t[pt.expando] = 1,
        ct.attributes = !t.getAttribute(pt.expando)
    }();
    var qt = {
    ...
    !function() {
        ...
        for (e in {
            ...
            n = "on" + e,
            (ct[e] = n in t) || (i.setAttribute(n, "t"),
            ct[e] = i.attributes[n].expando === !1);
        i = null
    }();
    ...
    pt.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (m) {
                ...
                s = e.length; s--; )
                    ...
                    (h = a[p]) || (h = a[p] = [],
                    h.delegateCount = 0,
                    l.setup && l.setup.call(t, i, f, u) !== !1 || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))),
                    l.add && (l.add.call(t, c),
        ...
        remove: function(t, e, n, i, r) {
            ...
            if (m && (u = m.events)) {
                ...
                l = e.length; l--; )
                    ...
                    f = (s[2] || "").split(".").sort(),
                    p) {
                        for (c = pt.event.special[p] || {},
                        p = (i ? c.delegateType : c.bindType) || p,
                        h = u[p] || [],
                        s = s[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        d = o = h.length; o--; )
                            a = h[o],
                            !r && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (h.splice(o, 1),
                            a.selector && h.delegateCount--,
                            c.remove && c.remove.call(t, a));
                        d && !h.length && (c.teardown && c.teardown.call(t, f, m.handle) !== !1 || pt.removeEvent(t, p, m.handle),
                        delete u[p])
                    } else
                        for (p in u)
                            pt.event.remove(t, p + e[l], n, i, !0);
                pt.isEmptyObject(u) && (delete m.handle,
        ...
        trigger: function(e, n, i, r) {
            ...
            if (s = u = i = i || it,
            3 !== i.nodeType && 8 !== i.nodeType && !Xt.test(p + pt.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."),
            p = f.shift(),
            f.sort()),
            a = p.indexOf(":") < 0 && "on" + p,
            ...
            r || !l.trigger || l.trigger.apply(i, n) !== !1)) {
                if (!r && !l.noBubble && !pt.isWindow(i)) {
                    for (d = l.delegateType || p,
                    Xt.test(d + p) || (s = s.parentNode); s; s = s.parentNode)
                        h.push(s),
                        u = s;
                    u === (i.ownerDocument || it) && h.push(u.defaultView || u.parentWindow || t)
                }
                for (c = 0; (s = h[c++]) && !e.isPropagationStopped(); )
                    e.type = c > 1 ? d : l.bindType || p,
                    o = (pt._data(s, "events") || {})[e.type] && pt._data(s, "handle"),
                    o && o.apply(s, n),
                    o = a && s[a],
                    o && o.apply && Lt(s) && (e.result = o.apply(s, n),
                    e.result === !1 && e.preventDefault());
                if (e.type = p,
                !r && !e.isDefaultPrevented() && (!l._default || l._default.apply(h.pop(), n) === !1) && Lt(i) && a && i[p] && !pt.isWindow(i)) {
                    u = i[a],
                    u && (i[a] = null),
            ...
            !l.preDispatch || l.preDispatch.call(this, t) !== !1) {
                ...
                e = 0; (r = a[e++]) && !t.isPropagationStopped(); )
                    ...
                    n = 0; (o = r.handlers[n++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = o.data,
                        i = ((pt.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, s),
                ...
                for (; d != this; d = d.parentNode || this)
                    if (1 === d.nodeType && (d.disabled !== !0 || "click" !== t.type)) {
                        ...
                        n = 0; n < s; n++)
                            o = e[n],
                            r = o.selector + " ",
                            void 0 === i[r] && (i[r] = o.needsContext ? pt(r, this).index(d) > -1 : pt.find(r, this, null, [d]).length),
                            i[r] && i.push(o);
                        i.length && a.push({
                            elem: d,
                            handlers: i
    ...
    pt.each({
        ...
        pt.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return r && (r === i || pt.contains(i, r)) || (t.type = o.origType,
    ...
    ct.focusin || pt.each({
        ...
        pt.event.special[e] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , r = pt._data(i, e) - 1;
                r ? pt._data(i, e, r) : (i.removeEventListener(t, n, !0),
                pt._removeData(i, e))
            }
        }
    }),
    ...
    pt.extend({
        ...
        clone: function(t, e, n) {
            ...
            !(ct.noCloneEvent && ct.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || pt.isXMLDoc(t)))
                for (i = f(o),
                s = f(t),
                a = 0; null != (r = s[a]); ++a)
                    i[a] && k(r, i[a]);
        ...
        cleanData: function(t, e) {
            for (var n, i, r, o, a = 0, s = pt.expando, d = pt.cache, l = ct.attributes, u = pt.event.special; null != (n = t[a]); a++)
                ...
                o = r && d[r])) {
                    if (o.events)
                        for (i in o.events)
                            u[i] ? pt.event.remove(n, i) : pt.removeEvent(n, i, o.handle);
                    d[r] && (delete d[r],
    ...
    pt.each({
        ...
        pt.fn[t] = function(t) {
            for (var n, i = 0, r = [], o = pt(t), a = o.length - 1; i <= a; i++)
    ...
    var de, le = {
        HTML: "block",
        BODY: "block"
    }, ue = /^margin/, ce = new RegExp("^(" + Mt + ")(?!px)[a-z%]+$","i"), he = function(t, e, n, i) {
        var r, o, a = {};
        for (o in e)
            a[o] = t.style[o],
            t.style[o] = e[o];
    ...
    !function() {
        function e() {
            ...
            n = r = s = !1,
            i = a = !0,
            t.getComputedStyle && (u = t.getComputedStyle(l),
            n = "1%" !== (u || {}).top,
            s = "2px" === (u || {}).marginLeft,
            r = "4px" === (u || {
                width: "4px"
        ...
        ct.opacity = "0.5" === l.style.opacity,
        ct.cssFloat = !!l.style.cssFloat,
        l.style.backgroundClip = "content-box",
        l.cloneNode(!0).style.backgroundClip = "",
        ct.clearCloneStyle = "content-box" === l.style.backgroundClip,
        ...
        l.innerHTML = "",
        d.appendChild(l),
        ct.boxSizing = "" === l.style.boxSizing || "" === l.style.MozBoxSizing || "" === l.style.WebkitBoxSizing,
        pt.extend(ct, {
    ...
    ge = function(t, e, n) {
        ...
        n && !ct.pixelMarginRight() && ce.test(a) && ue.test(e) && (i = s.width,
        r = s.minWidth,
        o = s.maxWidth,
    ...
    pt.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (e = pt.cssProps[s] || (pt.cssProps[s] = L(s) || s),
                a = pt.cssHooks[e] || pt.cssHooks[s],
                void 0 === n)
                    return a && "get"in a && void 0 !== (r = a.get(t, !1, i)) ? r : d[e];
                if (o = typeof n,
                "string" === o && (r = Pt.exec(n)) && r[1] && (n = h(t, e, r),
                o = "number"),
                null != n && n === n && ("number" === o && (n += r && r[3] || (pt.cssNumber[s] ? "" : "px")),
        ...
        css: function(t, e, n, i) {
            ...
            return e = pt.cssProps[s] || (pt.cssProps[s] = L(s) || s),
            a = pt.cssHooks[e] || pt.cssHooks[s],
    ...
    pt.each(["height", "width"], function(t, e) {
        pt.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return ye.test(pt.css(t, "display")) && 0 === t.offsetWidth ? he(t, Ce, function() {
                        return P(t, e, i)
                    }) : P(t, e, i)
            },
            set: function(t, n, i) {
    ...
    ct.opacity || (pt.cssHooks.opacity = {
        ...
        set: function(t, e) {
            ...
            n.zoom = 1,
            (e >= 1 || "" === e) && "" === pt.trim(o.replace($e, "")) && n.removeAttribute && (n.removeAttribute("filter"),
            "" === e || i && !i.filter) || (n.filter = $e.test(o) ? o.replace($e, r) : o + " " + r)
        }
    }),
    ...
    pt.cssHooks.marginLeft = A(ct.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(ge(t, "marginLeft")) || (pt.contains(t.ownerDocument, t) ? t.getBoundingClientRect().left - he(t, {
                marginLeft: 0
            }, function() {
            ...
            var e, n, i, r = this[0];
            {
                if (arguments.length)
                    ...
                    this.each(function(n) {
                        var r;
                        1 === this.nodeType && (r = i ? t.call(this, n, pt(this).val()) : t,
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, r = t.options, o = pt.makeArray(e), a = r.length; a--; )
                        if (i = r[a],
                        pt.inArray(pt.valHooks.option.get(i), o) > -1)
                            try {
                                i.selected = n = !0
                            } catch (t) {
                                i.scrollHeight
    ...
    var Ae, Le, Ne = pt.expr.attrHandle, Ee = /^(?:checked|selected)$/i, Me = ct.getSetAttribute, Pe = ct.input;
    pt.fn.extend({
        attr: function(t, e) {
    ...
    pt.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return "undefined" == typeof t.getAttribute ? pt.prop(t, e, n) : (1 === o && pt.isXMLDoc(t) || (e = e.toLowerCase(),
                r = pt.attrHooks[e] || (pt.expr.match.bool.test(e) ? Le : Ae)),
                void 0 !== n ? null === n ? void pt.removeAttr(t, e) : r && "set"in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""),
        ...
        removeAttr: function(t, e) {
            ...
            if (o && 1 === t.nodeType)
                for (; n = o[r++]; )
                    i = pt.propFix[n] || n,
                    pt.expr.match.bool.test(n) ? Pe && Me || !Ee.test(n) ? t[i] = !1 : t[pt.camelCase("default-" + n)] = t[i] = !1 : pt.attr(t, n, ""),
                    t.removeAttribute(Me ? n : i)
        }
    }),
    Le = {
        set: function(t, e, n) {
            return e === !1 ? pt.removeAttr(t, n) : Pe && Me || !Ee.test(n) ? t.setAttribute(!Me && pt.propFix[n] || n, n) : t[pt.camelCase("default-" + n)] = t[n] = !0,
            n
        }
    },
    ...
    pt.extend({
        prop: function(t, e, n) {
            var i, r, o = t.nodeType;
            if (3 !== o && 8 !== o && 2 !== o)
                return 1 === o && pt.isXMLDoc(t) || (e = pt.propFix[e] || e,
                r = pt.propHooks[e]),
    ...
    pt.fn.extend({
        ...
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && (" " + U(n) + " ").replace(Oe, " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    }),
    ...
    pt.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, r) {
                ...
                i && (y = V(h, w, i)),
                y = K(h, y, w, o),
                o ? (h.ifModified && (C = w.getResponseHeader("Last-Modified"),
                C && (pt.lastModified[a] = C),
                C = w.getResponseHeader("etag"),
                C && (pt.etag[a] = C)),
                204 === e || "HEAD" === h.type ? x = "nocontent" : 304 === e ? x = "notmodified" : (x = y.state,
                c = y.data,
                v = y.error,
                o = !v)) : (v = x,
                !e && x || (x = "error",
                ...
                w.status = e,
                w.statusText = (n || x) + "",
                o ? g.resolveWith(p, [c, x, w]) : g.rejectWith(p, [w, x, v]),
                w.statusCode($),
                $ = void 0,
                l && f.trigger(o ? "ajaxSuccess" : "ajaxError", [w, h, o ? c : v]),
                m.fireWith(p, [w, x]),
            ...
            e = void 0),
            n = n || {};
            var r, o, a, s, d, l, u, c, h = pt.ajaxSetup({}, n), p = h.context || h, f = h.context && (p.nodeType || p.jquery) ? pt(p) : pt.event, g = pt.Deferred(), m = pt.Callbacks("once memory"), $ = h.statusCode || {}, v = {}, y = {}, b = 0, C = "canceled", w = {
                readyState: 0,
            ...
            w.success = w.done,
            w.error = w.fail,
            h.url = ((e || h.url || tn) + "").replace(Ue, "").replace(Ke, en[1] + "//"),
            h.type = n.method || n.type || h.method || h.type,
            h.dataTypes = pt.trim(h.dataType || "*").toLowerCase().match(jt) || [""],
            null == h.crossDomain && (r = Je.exec(h.url.toLowerCase()),
            ...
            a = h.url,
            h.hasContent || (h.data && (a = h.url += (Be.test(a) ? "&" : "?") + h.data,
            delete h.data),
            h.cache === !1 && (h.url = qe.test(a) ? a.replace(qe, "$1_=" + Qe++) : a + (Be.test(a) ? "&" : "?") + "_=" + Qe++)),
            h.ifModified && (pt.lastModified[a] && w.setRequestHeader("If-Modified-Since", pt.lastModified[a]),
            pt.etag[a] && w.setRequestHeader("If-None-Match", pt.etag[a])),
            (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && w.setRequestHeader("Content-Type", h.contentType),
    ...
    ct.cors = !!un && "withCredentials"in un,
    un = ct.ajax = !!un,
    ...
    pt.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
            ...
            s ? e[s] = e[s].replace(hn, "$1" + r) : e.jsonp !== !1 && (e.url += (Be.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
            e.converters["script json"] = function() {
                return a || pt.error(r + " was not called"),
                a[0]
            }
            ,
            e.dataTypes[0] = "json",
            ...
            ,
            i.always(function() {
                void 0 === o ? pt(t).removeProp(r) : t[r] = o,
    ...
    pt.parseHTML = function(t, e, n) {
        ...
        var i = wt.exec(t)
          , r = !n && [];
        return i ? [e.createElement(i[1])] : (i = $([t], e, r),
    ...
    pt.offset = {
        setOffset: function(t, e, n) {
            ...
            o = pt.css(t, "top"),
            d = pt.css(t, "left"),
            l = ("absolute" === u || "fixed" === u) && pt.inArray("auto", [o, d]) > -1,
            l ? (i = c.position(),
            a = i.top,
    ...
    pt.fn.extend({
        offset: function(t) {
            ...
            if (o)
                ...
                pt.contains(e, r) ? ("undefined" != typeof r.getBoundingClientRect && (i = r.getBoundingClientRect()),
                n = et(o),
                {
    ...
    pt.each(["top", "left"], function(t, e) {
        pt.cssHooks[e] = A(ct.pixelPosition, function(t, n) {
            if (n)
                return n = ge(t, e),
                ce.test(n) ? pt(t).position()[e] + "px" : n
        })
    }),
    pt.each({
        Height: "height",
...
+function(t) {
    ...
    function e(e) {
        return this.each(function() {
            ...
            "number" == typeof e ? r.to(e) : a ? r[a]() : o.interval && r.pause().cycle()
        })
    }
    var n = function(e, n) {
        this.$element = t(e),
...
+function(t) {
    ...
    function e(e, n) {
        ...
        if (t.inArray(i, n) !== -1)
            return t.inArray(i, o) === -1 || Boolean(e.nodeValue.match(d) || e.nodeValue.match(l));
        ...
        for (var a = t.map(i, function(t, e) {
            ...
            if (t.inArray(c, a) !== -1)
                for (var h = t.map(u.attributes, function(t) {
                    return t
                }), p = [].concat(i["*"] || [], i[c] || []), f = 0, g = h.length; f < g; f++)
                    e(h[f], p) || u.removeAttribute(h[f].nodeName);
            else
    ...
    function i(e) {
        return this.each(function() {
            var n = t(this)
              , i = n.data("bs.tooltip")
              , r = "object" == typeof e && e;
            !i && /destroy|hide/.test(e) || (i || n.data("bs.tooltip", i = new u(this,r)),
            "string" == typeof e && i[e]())
        })
    }
    ...
    u.prototype.getOptions = function(e) {
        ...
        for (var o in i)
            i.hasOwnProperty(o) && t.inArray(o, r) !== -1 && delete i[o];
    ...
    u.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (d) {
                ...
                a = "bottom" == a && l.bottom + h > f.bottom ? "top" : "top" == a && l.top - h < f.top ? "bottom" : "right" == a && l.right + c > f.width ? "left" : "left" == a && l.left - c < f.left ? "right" : a,
    ...
    u.prototype.hide = function(e) {
        ...
        !o.isDefaultPrevented())
            ...
            t.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", n).emulateTransitionEnd(u.TRANSITION_DURATION) : n(),
            this.hoverState = null,
            this
    }
    ,
...
+function(t) {
    ...
    e.prototype.process = function() {
        ...
        if (a && e < r[0])
            ...
            this.clear();
        for (t = r.length; t--; )
            a != o[t] && e >= r[t] && (void 0 === r[t + 1] || e < r[t + 1]) && this.activate(o[t])
    }
    ,
...
+function(t) {
    ...
    n.prototype.getState = function(t, e, n, i) {
        ...
        if ("bottom" == this.affixed)
            return null != n ? !(r + this.unpin <= o.top) && "bottom" : !(r + a <= t - i) && "bottom";
...
function(t) {
    "use strict";
    function e(t) {
        for (var e = window, n = t.split("."), i = n.pop(), r = 0, o = n.length; r < o; r++)
            e = e[n[r]];
        return function() {
            e[i].call(this)
        }
    ...
    i.prototype.init = function(e, n) {
        if (t.fn.popover.Constructor.prototype.init.call(this, "confirmation", e, n),
        (this.options.popout || this.options.singleton) && !n.rootSelector)
            throw new Error("The rootSelector option is required to use popout and singleton features since jQuery 3.");
        this.options._isDelegate = !1,
        n.selector ? this.options._selector = this._options._selector = n.rootSelector + " " + n.selector : n._selector ? (this.options._selector = n._selector,
        ...
        this.options._isDelegate || (this.eventBody = !1,
    ...
    i.prototype.setContent = function() {
        var e = this
          ...
          , r = this.getTitle()
          , o = this.getContent();
        if (i.find(".popover-title")[this.options.html ? "html" : "text"](r),
        ...
        this.options.buttons) {
            ...
            this.options.buttons.forEach(function(n) {
                a.append(t('<a href="#"></a>').addClass(n.class || "btn btn-xs btn-default").html(n.label || "").attr(n.attr || {}).prepend(t("<i></i>").addClass(n.icon), " ").one("click", function(i) {
                    ...
                    n.cancel ? (e.getOnCancel().call(e.$element, n.value),
                    e.$element.trigger("canceled.bs.confirmation", [n.value])) : (e.getOnConfirm().call(e.$element, n.value),
                    e.$element.trigger("confirmed.bs.confirmation", [n.value])),
                    e.inState && (e.inState.click = !1),
                    e.hide()
                }))
            }, this)
        } else
            i.find('[data-apply="confirmation"]').addClass(this.options.btnOkClass).html(this.options.btnOkLabel).attr(this.options._attributes).prepend(t("<i></i>").addClass(this.options.btnOkIcon), " ").off("click").one("click", function(n) {
                "#" === t(this).attr("href") && n.preventDefault(),
                e.getOnConfirm().call(e.$element),
                e.$element.trigger("confirmed.bs.confirmation"),
                e.$element.trigger(e.options.confirmationEvent, [!0]),
                e.hide()
            }),
            i.find('[data-dismiss="confirmation"]').addClass(this.options.btnCancelClass).html(this.options.btnCancelLabel).prepend(t("<i></i>").addClass(this.options.btnCancelIcon), " ").off("click").one("click", function(t) {
                t.preventDefault(),
                e.getOnCancel().call(e.$element),
                e.$element.trigger("canceled.bs.confirmation"),
                e.inState && (e.inState.click = !1),
                e.hide()
            });
        ...
        n = this,
        t(window).off("keyup.bs.confirmation").on("keyup.bs.confirmation", this._onKeyup.bind(this))
    }
    ,
    i.prototype.destroy = function() {
        n === this && (n = void 0,
        t(window).off("keyup.bs.confirmation")),
        t.fn.popover.Constructor.prototype.destroy.call(this)
    }
    ,
    i.prototype.hide = function() {
        n === this && (n = void 0,
        t(window).off("keyup.bs.confirmation")),
        t.fn.popover.Constructor.prototype.hide.call(this)
    }
    ,
    i.prototype._onKeyup = function(e) {
        if (!this.$tip)
            return n = void 0,
            void t(window).off("keyup.bs.confirmation");
        ...
        case "Escape":
            ...
            break;
        case "ArrowRight":
            r = s.length && s.next().length ? s.next() : a.children().first(),
            s.removeClass("active"),
            r.addClass("active").focus();
            break;
        case "ArrowLeft":
            r = s.length && s.prev().length ? s.prev() : a.children().last(),
            s.removeClass("active"),
            r.addClass("active").focus()
        }
    }
    ...
    t.fn.confirmation = function(e) {
        ...
        return n.rootSelector = this.selector || n.rootSelector,
        this.each(function() {
            var r = t(this)
              , o = r.data("bs.confirmation");
            (o || "destroy" != e) && (o || r.data("bs.confirmation", o = new i(this,n)),
            "string" == typeof e && (o[e](),
...
function(t) {
    function e(t, e, r) {
        ...
        if (/^(ch|di|in)/.test(r) && !s)
            n(t, a);
        else if (/^(un|en|de)/.test(r) && s)
            i(t, a);
        else if (r == _update)
            for (var d in s)
                s[d] ? n(t, d, !0) : i(t, d, !0);
        else
            e && "toggle" != r || (e || t[_callback]("ifClicked"),
            s ? o[_type] !== c && i(t, a) : n(t, a))
    }
    function n(e, n, r) {
        var u = e[0]
          , g = e.parent()
        ...
        if (u[n] !== !0) {
            if (!r && n == h && u[_type] == c && u.name) {
                var w = e.closest("form")
                  , x = 'input[name="' + u.name + '"]';
                x = w.length ? w.find(x) : t(x),
                x.each(function() {
                    this !== u && t(this).data(d) && i(t(this), n)
                })
            }
            $ ? (u[n] = !0,
            u[h] && i(e, h, "force")) : (r || (u[n] = !0),
            m && u[_indeterminate] && i(e, _indeterminate, !1)),
            s(e, m, n, r)
        }
        u[f] && o(e, _cursor, !0) && g.find("." + l).css(_cursor, "default"),
        g[_add](C || o(e, n) || ""),
        g.attr("role") && !$ && g.attr("aria-" + (v ? f : h), "true"),
        g[_remove](b || o(e, y) || "")
    }
    function i(t, e, n) {
        var i = t[0]
          ...
          , m = o(t, g + a(i[_type]))
          , $ = o(t, e + a(i[_type]));
        i[e] !== !1 && (!u && n && "force" != n || (i[e] = !1),
        s(t, d, g, n)),
        !i[f] && o(t, _cursor, !0) && r.find("." + l).css(_cursor, "pointer"),
        r[_remove]($ || o(t, e) || ""),
        r.attr("role") && !u && r.attr("aria-" + (c ? f : h), "false"),
        r[_add](m || o(t, g) || "")
    }
    function r(e, n) {
        e.data(d) && (e.parent().html(e.attr("style", e.data(d).s || "")),
        n && e[_callback](n),
        e.off(".i").unwrap(),
        t(_label + '[for="' + e[0].id + '"]').add(e.closest(_label)).off(".i"))
    }
    function o(t, e, n) {
        if (t.data(d))
            return t.data(d).o[e + (n ? "" : "Class")]
    }
    function a(t) {
        return t.charAt(0).toUpperCase() + t.slice(1)
    }
    function s(t, e, n, i) {
        i || (e && t[_callback]("ifToggled"),
        t[_callback]("ifChanged")[_callback]("if" + a(n)))
    }
    var d = "iCheck"
      , l = d + "-helper"
      , u = "checkbox"
    ...
    t.fn[d] = function(o, a) {
        ...
        p.each(function() {
            ...
            var a, s = this, p = s.id, g = -x + "%", $ = 100 + 2 * x + "%", S = {
                ...
                position: "absolute",
                opacity: 0
            }, k = s[_type] == u ? m.checkboxClass || "i" + u : m.radioClass || "i" + c, _ = t(_label + '[for="' + p + '"]').add(o.closest(_label)), D = !!m.aria, j = d + "-" + Math.random().toString(36).substr(2, 6), I = '<div class="' + k + '" ' + (D ? 'role="' + s[_type] + '" ' : "");
            D && _.each(function() {
                I += 'aria-labelledby="',
                this.id ? I += this.id : (this.id = j,
                I += j),
                I += '"'
            }),
            I = o.wrap(I + "/>")[_callback]("ifCreated").parent().append(m.insert),
            a = t('<ins class="' + l + '"/>').css(S).appendTo(I),
            o.data(d, {
                o: m,
                s: o.attr("style")
            }).css(T),
            !!m.inheritClass && I[_add](s.className || ""),
            !!m.inheritID && p && I.attr("id", d + "-" + p),
            "static" == I.css("position") && I.css("position", "relative"),
            e(o, !0, _update),
            _.length && _.on(_click + ".i mouseover.i mouseout.i " + _touch, function(n) {
                var i = n[_type]
                  , r = t(this);
                if (!s[f]) {
                    if (i == _click) {
                        ...
                        C && (/ut|nd/.test(i) ? (I[_remove](v),
                        r[_remove](w)) : (I[_add](v),
                        r[_add](w)));
                    if (!_mobile)
                        return !1;
                    n.stopPropagation()
            ...
            o.on(_click + ".i focus.i blur.i keyup.i keydown.i keypress.i", function(t) {
                var e = t[_type]
                  , r = t.keyCode;
                return e != _click && ("keydown" == e && 32 == r ? (s[_type] == c && s[h] || (s[h] ? i(o, h) : n(o, h)),
                !1) : void ("keyup" == e && s[_type] == c ? !s[h] && n(o, h) : /us|ur/.test(e) && I["blur" == e ? _remove : _add](y)))
            }),
            a.on(_click + " mousedown mouseup mouseover mouseout " + _touch, function(t) {
                var n = t[_type]
                  , i = /wn|up/.test(n) ? b : v;
                if (!s[f]) {
                    if (n == _click ? e(o, !1, !0) : (/wn|er|in/.test(n) ? I[_add](i) : I[_remove](i + " " + b),
                    _.length && C && i == v && _[/ut|nd/.test(n) ? _remove : _add](w)),
                    !_mobile)
                        return !1;
                    t.stopPropagation()
                }
    ...
    loadModule: function(t, e) {
        if (!this.hasModule(t))
            ...
            "function" == typeof e)
                ...
                for (var n in e)
                    e.hasOwnProperty(n) && (WHMCS[t][n] = {},
                    e[n].apply(WHMCS[t][n]))
    }
}),
jQuery(document).ready(function() {
    jQuery(document).on("click", ".disable-on-click", function() {
        if (jQuery(this).addClass("disabled"),
...
function(t) {
    ...
    provider: function() {
        ...
        this.preLinkInit = function(t) {
            ...
            if (n.length)
                if (n.data("hideOnPrelink")) {
                    ...
                    n.data("disableOnPrelink") ? (n.find(".btn").addClass("disabled"),
                    this.showProgressMessage(t)) : this.showProgressMessage(t);
            else
                this.showProgressMessage(t)
        }
        ,
        this.displayError = function(t, e, n) {
            ...
            this.feedbackContainer().removeClass("alert-info alert-success").addClass("alert alert-danger").html(i).slideDown()
        }
        ,
        this.displaySuccess = function(t, e, n) {
            ...
            case "2fa_needed":
                ...
                window.location = t.redirect_url ? decodeURIComponent(t.redirect_url) : decodeURIComponent(e.redirectUrl);
                break;
            case "linking_complete":
                ...
                l && (d = d.replace(/\.$/, " (" + l + ").")),
                this.feedbackContainer().removeClass("alert-danger alert-warning alert-info").addClass("alert alert-success").html(i + d);
                break;
            case "login_to_link":
                if (r === o)
                    d = this.feedbackMessage("login_to_link-signin-required"),
                    this.feedbackContainer().removeClass("alert-danger alert-success alert-info").addClass("alert alert-warning").html(i + d);
                else {
                    var u = jQuery("input[name=email]")
                      , c = jQuery("input[name=firstname]")
                      , h = jQuery("input[name=lastname]");
                    if ("" === u.val() && u.val(t.remote_account.email),
                    "" === c.val() && c.val(t.remote_account.firstname),
                    "" === h.val() && h.val(t.remote_account.lastname),
                    r === a)
            ...
            case "other_user_exists":
                ...
                this.feedbackContainer().removeClass("alert-info alert-success").addClass("alert alert-danger").html(i + d).slideDown();
                break;
            case "already_linked":
        ...
        this.signIn = function(t, e, n, i, r) {
            jQuery.ajax(t).done(function(t) {
                i(),
                WHMCS.authn.provider.displaySuccess(t, e, n);
...
function(t) {
    ...
    registration: function() {
        return this.prefillPassword = function(t) {
            if (t = t || {},
            "undefined" == typeof t.hideContainer) {
                var e = jQuery("#inputSecurityQId").attr("id") ? "#containerPassword" : "#containerNewUserSecurity";
                t.hideContainer = jQuery(e),
                t.hideInputs = !0
            } else
                "string" == typeof t.hideContainer && t.hideContainer.length && (t.hideContainer = jQuery(t.hideContainer));
            ...
            var n = function() {
                for (var e = WHMCS.utils.simpleRNG(), n = 0, i = t.form.password.length; n < i; n++)
                    jQuery("#" + t.form.password[n].id).val(e).trigger("keyup")
            };
...
function(t) {
    ...
    jqClient: function() {
        return _getSettings = function(t, e, n, i) {
            return "object" == typeof t ? t : ("function" == typeof e && (n = e,
            e = null),
            {
                url: t,
                data: e,
        ...
        this.jsonGet = function(t) {
            t = t || {},
            this.get(t.url, t.data, function(e) {
                e.warning ? (console.log("[WHMCS] Warning: " + e.warning),
                "function" == typeof t.warning && t.warning(e.warning)) : e.error ? (console.log("[WHMCS] Error: " + e.error),
                "function" == typeof t.error && t.error(e.error)) : "function" == typeof t.success && t.success(e)
    ...
    client: function() {
        ...
        return _beforeRequest = function(t) {
            return "undefined" == typeof t.type && (t.type = "GET"),
            t
        }
        ,
        this.request = function(t) {
            return t = _beforeRequest(t || {}),
            jQuery.ajax(t)
        }
        ,
...
function(t) {
    ...
    confirmation: function() {
        ...
        return this.register = function(e) {
            return "undefined" == typeof e && (e = "[data-toggle=confirmation]"),
    ...
    dataTable: function() {
        ...
        this.getTableById = function(t, e) {
            ...
            if ("undefined" == typeof n.tables[t]) {
                ...
                "undefined" != typeof f && (e.pageLength = f),
                n.tables[t] = n.initTable(i, e)
            } else if ("undefined" != typeof e) {
                var g = n.tables[t]
                  , m = g.init()
                  , $ = jQuery.extend(m, e);
                g.destroy(),
                n.tables[t] = n.initTable(i, $)
            }
            return n.tables[t]
        }
        ,
        ...
        this.rebindConfirmation = function(t) {
            for (var e = this, n = t.target.id, i = WHMCS.ui.confirmation.register(), r = 0, o = i.length; r < o; r++)
                jQuery(i[r]).on("confirmed.bs.confirmation", function(t) {
                    t.preventDefault(),
                    WHMCS.http.jqClient.post(jQuery(t.target).data("target-url"), {
                        token: csrfToken
                    }).done(function(t) {
    ...
    toolTip: function() {
        this.setTip = function(t, e) {
            ...
            return "in" !== n.hoverState && (n.hoverState = "in"),
    ...
    jsonForm: function() {
        return this.managedElements = "input,textarea,select",
        this.initFields = function(t) {
            var e = this;
        ...
        this.markFieldErrors = function(t, e) {
            ...
            for (var a in e)
                ...
                i = r.managedElements.split(",").map(function(t) {
                    return t + '[name="' + a + '"]'
                }).join(","),
                n = $(t).find(i),
                o && ($(n).parents(".form-group").addClass("has-error"),
                $(n).attr("title", o),
                $(n).tooltip());
        ...
        this.errorShake = function(t) {
            ...
            return t.each(function() {
                ...
                var i = "up" === e.direction || "down" === e.direction ? "top" : "left"
                  ...
                  , a = {}
                  , s = {};
                o[i] = ("pos" === r ? "-=" : "+=") + e.distance,
                a[i] = ("pos" === r ? "+=" : "-=") + 2 * e.distance,
                s[i] = ("pos" === r ? "-=" : "+=") + 2 * e.distance,
                t.animate(o, e.speed);
                for (var d = 1; d < e.times; d++)
                    t.animate(a, e.speed).animate(s, e.speed);
...
function(t) {
    ...
    return this.checkAllBound = !1,
    this.register = function() {
        this.checkAllBound || (this.bindCheckAll(),
        this.checkAllBound = !0)
    }
    ,
    this.bindCheckAll = function() {
        ...
        jQuery(t).click(function(t) {
            ...
            if (e.data("btn-check-toggle")) {
                var i = "Deselect All"
                  , r = "Select All";
                e.data("label-text-deselect") && (i = e.data("label-text-deselect")),
                e.data("label-text-select") && (r = e.data("label-text-select")),
                e.hasClass("toggle-active") ? (n.prop("checked", !1),
                e.text(r),
                e.removeClass("toggle-active")) : (n.prop("checked", !0),
                e.text(i),
                e.addClass("toggle-active"))
            } else
                e.data("btn-toggle-on") ? n.prop("checked", !0) : n.prop("checked", !1)
        })
    }
    ,
        ...
        if (!recaptchaLoadComplete) {
            ...
            if (e.each(function(e, n) {
                ...
                var i = jQuery(n)
                  ...
                  , l = i;
                d.length && (l = d),
                s.length || (l.append('<div id="divDynamicRecaptcha" class="g-recaptcha" data-toggle="tooltip" data-placement="bottom" data-trigger="manual" title="' + a + '"></div>'),
                s = l.find("#divDynamicRecaptcha")),
                o ? "invisible" !== s.data("size") && s.attr("data-size", "invisible") : s.hide(),
                s.attr("data-sitekey", recaptchaSiteKey);
                var u = i.find("input[name='submit']");
                if (u.length) {
                    var c = i.prop("action");
                    i.prop("action", c + "&submit=1"),
                    u.remove()
                }
                ...
                ,
                s.attr("data-callback", h),
                o ? i.on("submit", function(t) {
                    grecaptcha.getResponse().trim() || (t.preventDefault(),
                    grecaptcha.execute())
                }) : (t.push(function() {
    ...
    t.mixin = function(t) {
        ...
        t.prototype.initializePlugins = function(t) {
            ...
            e.isArray(t))
                for (n = 0,
                i = t.length; n < i; n++)
                    "string" == typeof t[n] ? a.push(t[n]) : (o.plugins.settings[t[n].name] = t[n].options,
                    a.push(t[n].name));
            else if (t)
                for (r in t)
                    t.hasOwnProperty(r) && (o.plugins.settings[r] = t[r],
                    a.push(r));
            for (; a.length; )
                o.require(a.shift())
        }
        ...
        t.prototype.loadPlugin = function(e) {
            ...
            i.requested[e] = !0,
            i.loaded[e] = r.fn.apply(n, [n.plugins.settings[e] || {}]),
            i.names.push(e)
        }
        ,
...
function(t, e) {
    ...
    t.prototype.getScoreFunction = function(t, e) {
        ...
        var d = function(t, e) {
            ...
            return t ? (t = String(t || ""),
            i = t.search(e.regex),
            i === -1 ? 0 : (n = e.string.length / t.length,
            0 === i && (n += .5),
            n)) : 0
        }
          , l = function() {
    ...
    t.prototype.getSortFunction = function(t, n) {
        ...
        if (a = this,
        t = a.prepareSearch(t, n),
        f = !t.query && n.sort_empty || n.sort,
        h = function(t, e) {
        ...
        f)
            for (r = 0,
            o = f.length; r < o; r++)
                (t.query || "$score" !== f[r].field) && d.push(f[r]);
        if (t.query) {
            for (p = !0,
            r = 0,
            o = d.length; r < o; r++)
    ...
    t.prototype.search = function(t, e) {
        ...
        e = i.options,
        t = i.query,
        o = e.score || a.getScoreFunction(i),
        t.length ? a.iterator(a.items, function(t, r) {
            n = o(t),
            (e.filter === !1 || n > 0) && i.items.push({
                score: n,
                id: r
            })
    ...
    ;
    var e = function(t, e) {
        return "number" == typeof t && "number" == typeof e ? t > e ? 1 : t < e ? -1 : 0 : (t = d(String(t || "")),
        e = d(String(e || "")),
        t > e ? 1 : e > t ? -1 : 0)
    }
      , n = function(t, e) {
      ...
      , d = function() {
        ...
        for (n in s)
            if (s.hasOwnProperty(n))
                for (i = s[n].substring(2, s[n].length - 1),
                r += i,
                t = 0,
                e = i.length; t < e; t++)
                    o[i.charAt(t)] = n;
...
function(t) {
    ...
    return this.simpleRNG = function() {
        for (var t = "./$_-#!,^*()|", e = 0, n = 0; e < 3; n++)
            e += Math.floor(10 * Math.random() / 2);
        e = Math.floor(e);
        for (var i = "", r = 0; r < e; r++)
            v = (Math.random() + 1).toString(24).split(".")[1],
            i += Math.random() > .5 ? btoa(v).substr(0, 4) : v,
            Math.random() > .5 && (i += t.substr(Math.floor(13 * Math.random()), 1));
        return i
    }
    ,
    ...
    this.validateBaseUrl = function() {
        ...
        window.whmcsBaseUrlAutoSet = !0) : "" === window.whmcsBaseUrl && "undefined" != typeof window.whmcsBaseUrlAutoSet && window.whmcsBaseUrlAutoSet === !0 && (window.whmcsBaseUrl = this.autoDetermineBaseUrl())
    }
    ,
    this.autoDetermineBaseUrl = function() {
        var t = window.location.href
          , e = -1;
        if ("undefined" != typeof t && (e = t.indexOf(".php")),
        e === -1 && (t = jQuery("#Primary_Navbar-Home a").attr("href"),
        "undefined" != typeof t && (e = t.indexOf(".php"))),
        e !== -1) {
            t = t.substring(0, e);
            var n = t.lastIndexOf("/");
            if (n !== !1)
    ...
    this.generatePassword = function(t) {
        for (var e = this.getPasswordCharacterSet(), n = "", i = 0; t > i; i++)
            n += e[this.randomInt(e.length)];
        return n
    }
    ,
    ...
    this.randomIntBrowserCrypto = function(t) {
        ...
        if ("getRandomValues"in e && "Uint32Array"in window && "function" == typeof Uint32Array || (e = null),
        null == e)
            return 0;
        var n = new Uint32Array(1);
        do
            e.getRandomValues(n);
        while (n[0] - n[0] % t > 4294967296 - t);return n[0] % t
    }
    ,
    this
}),
...
jQuery(document).ready(function() {
    function t(t, e, n) {
        ...
        r)
            for (var s = 0; s < r.length; s++)
                o += r[s].charCodeAt(0) >= 19968 ? r[s].length : 1;
        return '<div class="small-font">lines: ' + a + "&nbsp;&nbsp;&nbsp;words: " + o + (e ? '&nbsp;&nbsp;&nbsp;<span class="markdown-save">' + n + "</span>" : "") + "</div>"
    }
    function e() {
        o >= 0 && (0 == o && jQuery("span.markdown-save").html(saved),
        o--,
        setTimeout(e, 1e3))
    }
    ...
    jQuery(".panel-minimise").click(function(t) {
        t.preventDefault(),
        jQuery(this).hasClass("minimised") ? (jQuery(this).parents(".panel").find(".panel-body, .list-group").slideDown(),
    ...
    "" != jQuery(location).attr("hash").substr(1)) {
        ...
        jQuery(".list-group-tab-nav a").removeClass("active"),
        jQuery('a[href="' + n + '"]').addClass("active"),
        setTimeout(function() {
            window.scrollTo(0, 0)
        }, 1)
    }
    ...
    jQuery(".setBulkAction").click(function(t) {
        ...
        var e = jQuery(this).attr("id").replace("Link", "")
          , n = jQuery("#domainForm");
        if ("renewDomains" === e)
            n.attr("action", WHMCS.utils.getRouteUrl("/cart/domain/renew"));
        else {
    ...
    jQuery(document).on("click", ".delete-cc-email", function() {
        ...
        WHMCS.http.jqClient.jsonPost({
            ...
            success: function(e) {
                e.success && (t.closest(".ticket-cc-email").parent("div").slideUp("fast").remove(),
                n.slideUp("fast").removeClass("alert-danger hidden").addClass("alert-success").html(e.message).slideDown("fast"))
            },
            error: function(t) {
        ...
        r.is(":visible") && r.slideUp("fast"),
        WHMCS.http.jqClient.jsonPost({
            url: e.attr("action"),
            data: e.serialize(),
            success: function(t) {
                t.success && (n.find("span.email").html(i.val()).find("button").data("email", i.val()).end(),
                n.removeClass("hidden").appendTo(jQuery("#sidebarTicketCc").find(".list-group")),
                i.val(""),
                r.slideUp("fast").removeClass("alert-danger hidden").addClass("alert-success").html(t.message).slideDown("fast"))
            },
            error: function(t) {
    ...
    jQuery("a.autoLinked").click(function(t) {
        ...
        var e = window.open();
        e.opener = null,
        e.location = t.target.href
    }),
    jQuery("#inputAllowSso").on("switchChange.bootstrapSwitch", function(t, e) {
        e ? (jQuery("#ssoStatusTextEnabled").removeClass("hidden").show(),
        jQuery("#ssoStatusTextDisabled").hide()) : (jQuery("#ssoStatusTextDisabled").removeClass("hidden").show(),
    ...
    jQuery(".btn-service-sso").on("click", function(t) {
        ...
        var e = jQuery(this)
          , n = e.parents("form");
        0 == n.length && (n = e.find("form")),
        n.hasClass("disabled") || (e.find(".loading").removeClass("hidden").show().end().attr("disabled", "disabled"),
        WHMCS.http.jqClient.post(window.location.href, n.serialize(), function(t) {
            e.find(".loading").hide().end().removeAttr("disabled"),
            n.find(".login-feedback").html(""),
            t.error && n.find(".login-feedback").html(t.error).hide().removeClass("hidden").slideDown(),
            void 0 !== t.redirect && "window|" === t.redirect.substr(0, 7) && window.open(t.redirect.substr(7), "_blank")
        }, "json"))
    }),
    jQuery(".btn-sidebar-form-submit").on("click", function(t) {
        t.preventDefault(),
        jQuery(this).find(".loading").removeClass("hidden").show().end().attr("disabled", "disabled");
        var e = jQuery(this).parents("form");
        0 == e.length && (e = jQuery(this).find("form")),
        0 !== e.length && e.hasClass("disabled") === !1 ? e.submit() : jQuery(this).find(".loading").hide().end().removeAttr("disabled")
    }),
    ...
    jQuery(".generate-password").click(function(t) {
    ...
    jQuery("#btnGeneratePasswordInsert").click(WHMCS.ui.clipboard.copy).click(function(t) {
        ...
        for (var n = 0; n < e.length; n++)
            jQuery("#" + e[n]).val(jQuery("#inputGeneratePasswordOutput").val()).trigger("keyup")
    });
    var i = 0
      , r = "clientMDE"
      , o = 0;
    jQuery(".markdown-editor").each(function(n) {
        ...
        "undefined" == typeof a && (a = "client_area"),
        window[r + i.toString()] = jQuery(this).markdown({
            ...
            onShow: function(e) {
                ...
                i = !0,
                n && "undefined" != typeof n && e.setContent(n)),
                jQuery("#" + s).html(t(n, i, saved))
            },
            onChange: function(n) {
                var i = n.getContent()
                  , r = !1;
                "undefined" != typeof Storage && (o = 3,
                r = !0,
    ...
    s.submit(function(t) {
        t.preventDefault(),
        openModal(s.attr("action"), s.serialize(), "Loading...")
    }),
    $.fn.setInputError = function(t) {
        return this.parents(".form-group").addClass("has-error").find(".field-error-msg").text(t),
        this
    }
    ,
    jQuery.fn.showInputError = function() {
        return this.parents(".form-group").addClass("has-error").find(".field-error-msg").show(),
        this
    }
    ,
    jQuery("#frmPayment").on("submit", function() {
        var t = jQuery("#btnSubmit");
        t.find("span").toggleClass("hidden"),
    ...
    jQuery(".tld-filters a").click(function(t) {
        ...
        jQuery(this).hasClass("label-success") ? jQuery(this).removeClass("label-success") : jQuery(this).addClass("label-success"),
        e.is(":visible") && e.hide(),
        jQuery(".tld-row").removeClass("filtered-row"),
        jQuery(".tld-filters a.label-success").each(function(t) {
    ...
    jQuery("#frmReply").submit(function(t) {
    ...
    jQuery("#frmDomainContactModification").on("submit", function() {
        if (!allowSubmit) {
            ...
            t)
                return jQuery("#modalIRTPConfirmation").modal("show"),
                !1
        }
        return !0
    }),
    ...
    l && !u && jQuery("section#home-banner").addClass("with-recaptcha"),
    jQuery(".domainchecker-homepage-captcha").length && !u && jQuery(c).submit(function(t) {
        var e = (jQuery(c).find('input[name="domain"]'),
        jQuery("#divDynamicRecaptcha"))
          , n = jQuery("#g-recaptcha-response")
          , i = jQuery("#inputCaptcha");
        return n.length && !n.val() ? (e.tooltip("show"),
        void t.preventDefault()) : i.length && !i.val() ? (i.tooltip("show"),
    ...
    jQuery("#inputNoStore").on("switchChange.bootstrapSwitch", function(t, e) {
        ...
        e || n.prop("disabled", !0).addClass("disabled"),
        e && n.removeClass("disabled").prop("disabled", !1)
    })
});
    ...
    !function(e, n) {
        ...
        return i = function() {
            ...
            t.prototype._containerPosition = function(t, e) {
                if (null == t && (t = this.options.state),
                this.$container.css("margin-left", function(e) {
                    return function() {
                        var n;
                        return n = [0, "-" + e._handleWidth + "px"],
                        e.options.indeterminate ? "-" + e._handleWidth / 2 + "px" : t ? e.options.inverse ? n[1] : n[0] : e.options.inverse ? n[0] : n[1]
                    }
                }(this)),
                e)
                    return setTimeout(function() {
                    ...
                    return function() {
                        ...
                        t._containerPosition(null, function() {
                            if (t.options.animate)
                                return t.$wrapper.addClass("" + t.options.baseClass + "-animate")
                        })
                    }
                }(this),
                this.$wrapper.is(":visible") ? t() : e = n.setInterval(function(i) {
                    return function() {
                ...
                return this.$element.on({
                    "change.bootstrapSwitch": function(t) {
                        return function(n, i) {
                            ...
                            r = t.$element.is(":checked"),
                            t._containerPosition(r),
                            r !== t.options.state)
                                return t.options.state = r,
            ...
            t.prototype._labelHandlers = function() {
                return this.$label.on({
                    "mousedown.bootstrapSwitch touchstart.bootstrapSwitch": function(t) {
                        return function(e) {
                            if (!(t._dragStart || t.options.disabled || t.options.readonly))
                                return e.preventDefault(),
                                e.stopPropagation(),
                    ...
                    "mousemove.bootstrapSwitch touchmove.bootstrapSwitch": function(t) {
                        return function(e) {
                            ...
                            n = (e.pageX || e.originalEvent.touches[0].pageX) - t._dragStart,
                            !(n < -t._handleWidth || n > 0)))
                                return t._dragEnd = n,
                    ...
                    "mouseup.bootstrapSwitch touchend.bootstrapSwitch": function(t) {
                        return function(e) {
                            ...
                            if (t._dragStart)
                                ...
                                t._dragEnd ? (n = t._dragEnd > -(t._handleWidth / 2),
                                t._dragEnd = !1,
                                t.state(t.options.inverse ? !n : n)) : t.state(!t.options.state),
                                t._dragStart = !1
                        }
                    }(this),
            ...
            t.prototype._formHandler = function() {
                var t;
                if (t = this.$element.closest("form"),
                !t.data("bootstrap-switch"))
                    return t.on("reset.bootstrapSwitch", function() {
        ...
        e.fn.bootstrapSwitch = function() {
            ...
            this.each(function() {
                ...
                a || t.data("bootstrap-switch", a = new i(this,r)),
                "string" == typeof r)
                    return o = a[r].apply(a, n)
            }),
            o
        }
        ,
...
function(t) {
    ...
    var e = function(e, n) {
        ...
        t.each(i, function(i, r) {
            "undefined" != typeof t(e).data(r) && (n = "object" == typeof n ? n : {},
            n[r] = t(e).data(r))
        }),
    ...
    e.prototype = {
        ...
        __alterButtons: function(e, n) {
            ...
            t.each(i, function(t, i) {
                var a = !0;
                a = !r && i.indexOf(e) < 0,
                a === !1 && n(o.$editor.find('button[data-handler="' + i + '"]'))
            })
        },
            ...
            for (i = 0; i < e.length; i++) {
                ...
                for (s = 0; s < d.length; s++) {
                    ...
                    for (l = 0; l < u.length; l++) {
                        var h, p, f = u[l], g = r + "-" + f.name, m = this.__getIcon(f.icon), $ = f.btnText ? f.btnText : "", v = f.btnClass ? f.btnClass : "btn", y = f.tabIndex ? f.tabIndex : "-1", b = "undefined" != typeof f.hotkey ? f.hotkey : "", C = "undefined" != typeof jQuery.hotkeys && "" !== b ? " (" + b + ")" : "";
                        h = t("<button></button>"),
                        h.text(" " + this.__localize($)).addClass("btn-default btn-sm").addClass(v),
                        ...
                        f.toggle === !0 && h.attr("data-toggle", "button"),
                        p = t("<span/>"),
                        p.addClass(m),
                        p.prependTo(h),
                        c.append(h),
        ...
        showEditor: function() {
            var e, n = this, i = this.$ns, r = this.$element, o = (r.css("height"),
            r.css("width"),
            ...
            if (null === this.$editor) {
                var u = t("<div/>", {
                  ...
                  , c = [];
                if (d.buttons.length > 0 && (c = c.concat(d.buttons[0])),
                d.additionalButtons.length > 0 && t.each(d.additionalButtons[0], function(e, n) {
                ...
                c.length > 0 && (u = this.__buildButtons([c], u)),
                d.fullscreen.enable && u.append('<div class="md-controls"><a class="md-control md-control-fullscreen" href="#"><span class="' + this.__getIcon(d.fullscreen.icons.fullscreenOn) + '"></span></a></div>').on("click", ".md-control-fullscreen", function(t) {
                    t.preventDefault(),
                    n.setFullscreen(!0)
                }),
                l.append(u),
                r.is("textarea"))
                    ...
                    l.append(e),
                    o.el = r,
                    o.type = r.prop("tagName").toLowerCase(),
                    o.content = r.html(),
                ...
                if (d.savable) {
                    ...
                    a.push($),
                    s.push(d.onSave),
                    f.append('<button class="btn btn-success" data-provider="' + i + '" data-handler="' + $ + '"><i class="icon icon-white icon-ok"></i> ' + this.__localize("Save") + "</button>")
                }
                if (m = "function" == typeof d.footer ? d.footer(this) : d.footer,
                "" !== t.trim(m) && (g = !0,
                f.append(m)),
                g && l.append(f),
                d.width && "inherit" !== d.width && (jQuery.isNumeric(d.width) ? (l.css("display", "table"),
                e.css("width", d.width + "px")) : l.addClass(d.width)),
                d.height && "inherit" !== d.height)
                    if (jQuery.isNumeric(d.height)) {
                        var v = d.height;
                        u && (v = Math.max(0, v - u.outerHeight())),
                        f && (v = Math.max(0, v - f.outerHeight())),
                        e.css("height", v + "px")
                    } else
                        l.addClass(d.height);
                this.$editor = l,
                ...
                this.$editor.show();
            return d.autofocus && (this.$textarea.focus(),
            ...
            this.hideButtons(d.hiddenButtons),
            this.disableButtons(d.disabledButtons),
            d.onShow(this),
            this
        },
        ...
        buttons: [[{
            ...
            data: [{
                ...
                callback: function(t) {
                    ...
                    "**" === r.substr(i.start - 2, 2) && "**" === r.substr(i.end, 2) ? (t.setSelection(i.start - 2, i.end + 2),
                ...
                callback: function(t) {
                    ...
                    "_" === r.substr(i.start - 1, 1) && "_" === r.substr(i.end, 1) ? (t.setSelection(i.start - 1, i.end + 1),
                    t.replaceSelection(e),
                ...
                callback: function(t) {
                    ...
                    i = 4,
                    "### " === a.substr(o.start - i, i) || (i = 3,
                    "###" === a.substr(o.start - i, i)) ? (t.setSelection(o.start - i, o.end),
                    t.replaceSelection(e),
                    n = o.start - i) : o.start > 0 && (r = a.substr(o.start - 1, 1),
            ...
            data: [{
                ...
                callback: function(e) {
                    ...
                    r = prompt(e.__localize("Insert Image Hyperlink"), "http://");
            ...
            data: [{
                ...
                callback: function(t) {
                    ...
                    t.replaceSelection(e),
                    n = i.start - 4) : "`" === r.substr(i.start - 1, 1) && "`" === r.substr(i.end, 1) ? (t.setSelection(i.start - 1, i.end + 1),
                    t.replaceSelection(e),
                    n = i.start - 1) : r.indexOf("\n") > -1 ? (t.replaceSelection("```\n" + e + "\n```"),
...
function(t) {
    ...
    function r(e) {
        ...
        t.each(e, function(t, s) {
            n = t.match(/^([^A-Z]+?)([A-Z])/),
            n && o.indexOf(n[1] + " ") !== -1 && (i = t.replace(n[0], n[2].toLowerCase()),
            a[i] = t,
            "o" === n[1] && r(e[t]))
        }),
        e._hungarianMap = a
    ...
    function o(e, n, a) {
        ...
        t.each(n, function(r, d) {
            s = e._hungarianMap[r],
            s === i || !a && n[s] !== i || ("o" === s.charAt(0) ? (n[s] || (n[s] = {}),
            t.extend(!0, n[s], n[r]),
            o(e[s], n[s], a)) : n[s] = n[r])
        })
    }
    ...
    function s(t) {
        ...
        if (e)
            for (var n = 0, i = e.length; n < i; n++)
                e[n] && o(Vt.models.oSearch, e[n])
    }
    function d(e) {
        fe(e, "orderable", "bSortable"),
        fe(e, "orderData", "aDataSort"),
        fe(e, "orderSequence", "asSorting"),
    ...
    function l(e) {
        if (!Vt.__browser) {
            ...
            var i = t("<div/>").css({
              ...
              , r = i.children()
              , o = r.children();
            n.barWidth = r[0].offsetWidth - r[0].clientWidth,
            n.bScrollOversize = 100 === o[0].offsetWidth && 100 !== r[0].clientWidth,
            n.bScrollbarLeft = 1 !== Math.round(o.offset().left),
            n.bBounding = !!i[0].getBoundingClientRect().width,
            i.remove()
        }
        t.extend(e.oBrowser, Vt.__browser),
        e.oScroll.iBarWidth = Vt.__browser.barWidth
    }
    function u(t, e, n, r, o, a) {
        var s, d = r, l = !1;
        for (n !== i && (s = n,
        l = !0); d !== o; )
            t.hasOwnProperty(d) && (s = l ? e(s, t[d], d, t) : t[d],
            l = !0,
            d += a);
        return s
    }
    function c(e, i) {
        ...
        s[o] = t.extend({}, Vt.models.oSearch, s[o]),
        h(e, o, t(i).data())
    }
    function h(e, n, r) {
        var a = e.aoColumns[n]
        ...
        a._bAttrSrc = t.isPlainObject(c) && (f(c.sort) || f(c.type) || f(c.filter)),
        a._setter = null,
        ...
        a.bSortable && (g || m) ? g && !m ? (a.sSortingClass = s.sSortableAsc,
        a.sSortingClassJUI = s.sSortJUIAscAllowed) : !g && m ? (a.sSortingClass = s.sSortableDesc,
        a.sSortingClassJUI = s.sSortJUIDescAllowed) : (a.sSortingClass = s.sSortable,
        a.sSortingClassJUI = s.sSortJUI) : (a.sSortingClass = s.sSortableNone,
        a.sSortingClassJUI = "")
    }
    function p(t) {
    ...
    function v(t) {
        ...
        n = c.length; e < n; e++)
            ...
            !d.sType && d._sManualType)
                ...
                o = p.length; r < o; r++) {
                    for (a = 0,
                    s = h.length; a < s && (u[a] === i && (u[a] = S(t, a, e, "type")),
                    l = p[r](u[a], t),
                ...
                l = g.length; d < l; d++)
                    if ("number" == typeof g[d] && g[d] >= 0) {
                        for (; f.length <= g[d]; )
                            c(e);
                        o(g[d], p)
                    } else if ("number" == typeof g[d] && g[d] < 0)
                        o(f.length + g[d], p);
                    else if ("string" == typeof g[d])
                        for (u = 0,
                        h = f.length; u < h; u++)
                            ("_all" == g[d] || t(f[u].nTh).hasClass(g[d])) && o(u, p)
            }
        if (r)
            for (a = 0,
            s = r.length; a < s; a++)
    ...
    function b(e, n, r, o) {
        ...
        s._aData = n,
        e.aoData.push(s);
        for (var d = e.aoColumns, l = 0, u = d.length; l < u; l++)
            d[l].sType = null;
        e.aiDisplayMaster.push(a);
        var c = e.rowIdFn(n);
        return c !== i && (e.aIds[c] = s),
        !r && e.oFeatures.bDeferRender || E(e, a, r, o),
        a
    }
    function C(e, n) {
        var i;
    ...
    function S(t, e, n, r) {
        ...
        if (l === i)
            return t.iDrawError != o && null === d && (Lt(t, 0, "Requested unknown parameter " + ("function" == typeof a.mData ? "{function}" : "'" + a.mData + "'") + " for row " + e + ", column " + n, 4),
            t.iDrawError = o),
            d;
    ...
    function D(e) {
        ...
        var n = function(e, r, o) {
            for (var a, s, d, l, u, c = k(o), h = c[c.length - 1], p = 0, f = c.length - 1; p < f; p++) {
                ...
                d && (c[p] = c[p].replace(me, ""),
                e = e[c[p]](r)),
                null !== e[c[p]] && e[c[p]] !== i || (e[c[p]] = {}),
                e = e[c[p]]
            }
    ...
    function A(t, e, n) {
        for (var r = -1, o = 0, a = t.length; o < a; o++)
            t[o] == e ? r = o : t[o] > e && t[o]--;
    ...
    function L(t, e, n, r) {
        ...
        if ("dom" !== n && (n && "auto" !== n || "dom" !== s.src)) {
            ...
            s._aData = N(t, s, r, r === i ? i : s._aData).data;
        s._aSortData = null,
        s._aFilterData = null;
        var u = t.aoColumns;
        if (r !== i)
          ...
          , g = function(e) {
            if (r === i || r === c)
                ...
                s && s._bAttrSrc) {
                    ...
                    p ? (s._setter || (s._setter = D(s.mData)),
                    s._setter(o, d)) : o[c] = d;
            c++
        };
        if (u)
            for (; u; )
                a = u.nodeName.toUpperCase(),
                "TD" != a && "TH" != a || (g(u),
                l.push(u)),
                u = u.nextSibling;
        else {
    ...
    function E(e, i, r, o) {
        ...
        if (null === c.nTr) {
            for (a = r || n.createElement("tr"),
            c.nTr = a,
            c.anCells = p,
            a._DT_RowIndex = i,
            M(e, c),
            l = 0,
            u = e.aoColumns.length; l < u; l++)
                d = e.aoColumns[l],
                s = r ? o[l] : n.createElement(d.sCellType),
                s._DT_CellIndex = {
                    row: i,
                    column: l
                },
                p.push(s),
                r && !d.mRender && d.mData === l || t.isPlainObject(d.mData) && d.mData._ === l + ".display" || (s.innerHTML = S(e, i, l, "display")),
                d.sClass && (s.className += " " + d.sClass),
                d.bVisible && !r ? a.appendChild(s) : !d.bVisible && r && s.parentNode.removeChild(s),
    ...
    function M(e, n) {
        ...
        if (i) {
            ...
            r.DT_RowClass) {
                ...
                n.__rowc = n.__rowc ? pe(n.__rowc.concat(a)) : a,
                t(i).removeClass(n.__rowc.join(" ")).addClass(r.DT_RowClass)
            }
            r.DT_RowAttr && t(i).attr(r.DT_RowAttr),
            r.DT_RowData && t(i).data(r.DT_RowData)
        }
    }
    function P(e) {
        var n, i, r, o, a, s = e.nTHead, d = e.nTFoot, l = 0 === t("th, td", s).length, u = e.oClasses, c = e.aoColumns;
        for (l && (o = t("<tr/>").appendTo(s)),
        n = 0,
        i = c.length; n < i; n++)
            a = c[n],
            r = t(a.nTh).addClass(a.sClass),
            l && r.appendTo(o),
            e.oFeatures.bSort && (r.addClass(a.sSortingClass),
            a.bSortable !== !1 && (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId),
            kt(e, a.nTh, n))),
            a.sTitle != r[0].innerHTML && r.html(a.sTitle),
            Ot(e, "header")(e, r, a, u);
        if (l && Q(e.aoHeader, s),
        t(s).find(">tr").attr("role", "row"),
        t(s).find(">tr>th, >tr>td").addClass(u.sHeaderTH),
        t(d).find(">tr>th, >tr>td").addClass(u.sFooterTH),
        null !== d) {
            var h = e.aoFooter[0];
            for (n = 0,
            i = h.length; n < i; n++)
    ...
    function R(e, n, r) {
        ...
        if (n) {
            ...
            a = n.length; o < a; o++) {
                ...
                f[o].nTr = n[o].nTr,
                s = m - 1; s >= 0; s--)
                    e.aoColumns[s].bVisible || r || f[o].splice(s, 1);
                g.push([])
            }
            for (o = 0,
            a = f.length; o < a; o++) {
                ...
                d = f[o].length; s < d; s++)
                    ...
                    p = 1,
                    g[o][s] === i) {
                        for (c.appendChild(f[o][s].cell),
                        g[o][s] = 1; f[o + h] !== i && f[o][s].cell == f[o + h][s].cell; )
                            g[o + h][s] = 1,
                            h++;
    ...
    function H(e) {
        ...
        e.oLanguage)
          ...
          , c = e.aiDisplay;
        e.bDrawing = !0,
        l !== i && l !== -1 && (e._iDisplayStart = u ? l : l >= e.fnRecordsDisplay() ? 0 : l,
        ...
        if (0 !== c.length)
            for (var f = u ? 0 : h, g = u ? e.aoData.length : p, $ = f; $ < g; $++) {
                ...
                if (0 !== s) {
                    var C = a[o % s];
                    y._sRowStripe != C && (t(b).removeClass(y._sRowStripe).addClass(C),
                    y._sRowStripe = C)
                }
                Rt(e, "aoRowCallback", null, [b, y._aData, o, $]),
                r.push(b),
                o++
            }
        else {
            var w = d.sZeroRecords;
            1 == e.iDraw && "ajax" == Ft(e) ? w = d.sLoadingRecords : d.sEmptyTable && 0 === e.fnRecordsTotal() && (w = d.sEmptyTable),
            r[0] = t("<tr/>", {
                class: s ? a[0] : ""
            }).append(t("<td />", {
                valign: "top",
        ...
        Rt(e, "aoHeaderCallback", "header", [t(e.nTHead).children("tr")[0], j(e), h, p, c]),
        Rt(e, "aoFooterCallback", "footer", [t(e.nTFoot).children("tr")[0], j(e), h, p, c]);
        var x = t(e.nTBody);
        x.children().detach(),
        x.append(t(r)),
    ...
    function O(t, e) {
        var n = t.oFeatures
          ...
          , r = n.bFilter;
        i && xt(t),
        r ? K(t, t.oPreviousSearch) : t.aiDisplay = t.aiDisplayMaster.slice(),
        e !== !0 && (t._iDisplayStart = 0),
        t._drawHold = e,
        H(t),
        t._drawHold = !1
    }
            ...
            "<" == d) {
                ...
                "'" == u || '"' == u) {
                    ...
                    h = 2; p[f + h] != u; )
                        c += p[f + h],
                        h++;
                    if ("H" == c ? c = n.sJUIHeader : "F" == c && (c = n.sJUIFooter),
                    c.indexOf(".") != -1) {
                        var g = c.split(".");
                        l.id = g[0].substr(1, g[0].length - 1),
                        l.className = g[1]
                    } else
                        "#" == c.charAt(0) ? l.id = c.substr(1, c.length - 1) : l.className = c;
                    f += h
                }
                a.append(l),
                a = t(l)
                ...
                a = a.parent();
            else if ("l" == d && o.bPaginate && o.bLengthChange)
                s = lt(e);
            else if ("f" == d && o.bFilter)
                s = V(e);
            else if ("r" == d && o.bProcessing)
                s = ht(e);
            else if ("t" == d)
                s = ft(e);
            else if ("i" == d && o.bInfo)
                s = it(e);
            else if ("p" == d && o.bPaginate)
                s = ut(e);
    ...
    function B(t, e, n) {
        ...
        for (var r = 0, o = n.length; r < o; r++)
            for (var a = 0, s = n[r].length; a < s; a++)
                !n[r][a].unique || i[a] && t.bSortCellsTop || (i[a] = n[r][a].cell);
        return i
    }
    function W(e, n, i) {
        if (Rt(e, "aoServerParams", "serverParams", [n]),
        n && t.isArray(n)) {
            var r = {}
              , o = /(.*?)\[\]$/;
        ...
        var a, s = e.ajax, d = e.oInstance, l = function(t) {
            Rt(e, null, "xhr", [e, t, e.jqXHR]),
            i(t)
        };
        if (t.isPlainObject(s) && s.data) {
            a = s.data;
            var u = t.isFunction(a) ? a(n, e) : a;
            n = t.isFunction(a) && u ? u : t.extend(!0, n, u),
            delete s.data
        }
        var c = {
            data: n,
        ...
        e.fnServerData ? e.fnServerData.call(d, e.sAjaxSource, t.map(n, function(t, e) {
            return {
                name: e,
                value: t
            }
    ...
    function q(e) {
        ...
        for (n = 0; n < s; n++)
            r = a[n],
            o = u[n],
            i = "function" == typeof r.mData ? "function" : r.mData,
            m.columns.push({
                data: i,
                name: r.sName,
            ...
            g("mDataProp_" + n, i),
            d.bFilter && (g("sSearch_" + n, o.sSearch),
            g("bRegex_" + n, o.bRegex),
            g("bSearchable_" + n, r.bSearchable)),
            d.bSort && g("bSortable_" + n, r.bSortable);
        d.bFilter && (g("sSearch", l.sSearch),
        g("bRegex", l.bRegex)),
        d.bSort && (t.each(h, function(t, e) {
            m.order.push({
                column: e.col,
                dir: e.dir
            }),
    ...
    function K(t, e, n) {
        ...
        if (v(t),
        "ssp" != Ft(t)) {
            Y(t, e.sSearch, n, s(e), e.bSmart, e.bCaseInsensitive),
            a(e);
            for (var d = 0; d < o.length; d++)
                X(t, o[d].sSearch, d, s(o[d]), o[d].bSmart, o[d].bCaseInsensitive);
            J(t)
        } else
            a(e);
        t.bFiltered = !0,
    ...
    function J(e) {
        for (var n, i, r = Vt.ext.search, o = e.aiDisplay, a = 0, s = r.length; a < s; a++) {
            for (var d = [], l = 0, u = o.length; l < u; l++)
                i = o[l],
                n = e.aoData[i],
                r[a](e, n._aFilterData, i, n._aData, l) && d.push(i);
            o.length = 0,
            t.merge(o, d)
        }
    }
    function X(t, e, n, i, r, o) {
        if ("" !== e)
            for (var a, s = t.aiDisplay, d = Z(e, i, r, o), l = s.length - 1; l >= 0; l--)
                a = t.aoData[s[l]]._aFilterData[n],
                d.test(a) || s.splice(l, 1)
    }
    function Y(t, e, n, i, r, o) {
        var a, s, d, l = Z(e, i, r, o), u = t.oPreviousSearch.sSearch, c = t.aiDisplayMaster;
        if (0 !== Vt.ext.search.length && (n = !0),
        s = tt(t),
        e.length <= 0)
            t.aiDisplay = c.slice();
        else
            for ((s || n || u.length > e.length || 0 !== e.indexOf(u) || t.bSorted) && (t.aiDisplay = c.slice()),
            a = t.aiDisplay,
            d = a.length - 1; d >= 0; d--)
                l.test(t.aoData[a[d]]._sFilterRow) || a.splice(d, 1)
    }
    function Z(e, n, i, r) {
        if (e = n ? e : $e(e),
        i) {
    ...
    function tt(t) {
        ...
        r = t.aoData.length; n < r; n++)
            ...
            !d._aFilterData) {
                ...
                o = l.length; i < o; i++)
                    e = l[i],
                    e.bSearchable ? (s = S(t, n, i, "filter"),
                    u[e.sType] && (s = u[e.sType](s)),
                    null === s && (s = ""),
                    "string" != typeof s && s.toString && (s = s.toString())) : s = "",
                    s.indexOf && s.indexOf("&") !== -1 && (ve.innerHTML = s,
                    s = ye ? ve.textContent : ve.innerText),
                    s.replace && (s = s.replace(/[\r\n]/g, "")),
                    a.push(s);
                d._aFilterData = a,
                d._sFilterRow = a.join("  "),
                c = !0
            }
        return c
    }
    ...
    function rt(e) {
        ...
        if (0 !== n.length) {
            ...
            s !== a && (d += " " + i.sInfoFiltered),
            d += i.sInfoPostFix,
            d = ot(e, d);
            var l = i.fnInfoCallback;
            null !== l && (d = l.call(e.oInstance, e, r, o, a, s, d)),
            t(n).html(d)
        }
    }
    function ot(t, e) {
    ...
    function at(t) {
        ...
        n = o.length; e < n; e++)
            i = o[e],
            i.sWidth && (i.nTh.style.width = Ct(i.sWidth));
        Rt(t, null, "preInit", [t]),
        O(t);
        var d = Ft(t);
    ...
    function lt(e) {
        for (var n = e.oClasses, i = e.sTableId, r = e.aLengthMenu, o = t.isArray(r[0]), a = o ? r[0] : r, s = o ? r[1] : r, d = t("<select/>", {
            ...
            d[0][l] = new Option(s[l],a[l]);
        var c = t("<div><label/></div>").addClass(n.sLength);
        return e.aanFeatures.l || (c[0].id = i + "_length"),
        c.children().append(e.oLanguage.sLengthMenu.replace("_MENU_", d[0].outerHTML)),
    ...
    function ut(e) {
        var n = e.sPaginationType
          ...
          , s = e.aanFeatures;
        return r || i.fnInit(e, a, o),
        s.p || (a.id = e.sTableId + "_paginate",
        e.aoDrawCallback.push({
            fn: function(t) {
                if (r) {
                    ...
                    for (e = 0,
                    n = s.p.length; e < n; e++)
                        Ot(t, "pageButton")(t, s.p[e], e, p, c, h)
                } else
                    i.fnUpdate(t, o)
            },
            sName: "pagination"
    ...
    function ft(e) {
        ...
        t($).css(o && i.bCollapse ? "max-height" : "height", o),
        e.nScrollHead = m,
        e.nScrollBody = $,
        e.nScrollFoot = v,
        e.aoDrawCallback.push({
    ...
    function gt(e) {
        ...
        if (e.scrollBarVis !== U && e.scrollBarVis !== i)
            return e.scrollBarVis = U,
            void p(e);
        e.scrollBarVis = U,
        A.children("thead, tfoot").remove(),
        E && (d = E.clone().prependTo(A),
        r = E.find("tr"),
        a = d.find("tr")),
        s = I.clone().prependTo(A),
        n = I.find("tr"),
        o = s.find("tr"),
        s.find("th, td").removeAttr("tabindex"),
        g || (k.width = "100%",
        y[0].style.width = "100%"),
        t.each(B(e, s), function(t, n) {
            l = f(e, t),
        ...
        c = A.outerWidth(),
        "" === g ? (N.width = "100%",
        P && (A.find("tbody").height() > S.offsetHeight || "scroll" == T.css("overflow-y")) && (N.width = Ct(A.outerWidth() - v)),
        c = A.outerWidth()) : "" !== m && (N.width = Ct(m),
        c = A.outerWidth()),
        mt(W, o),
        mt(function(e) {
            F.push(e.innerHTML),
            H.push(Ct(t(e).css("width")))
        }, o),
        mt(function(e, n) {
        ...
        t(a).height(0)),
        mt(function(t, e) {
            t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + F[e] + "</div>",
            t.style.width = H[e]
        }, o),
        E && mt(function(t, e) {
            t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + Q[e] + "</div>",
            t.style.width = O[e]
        }, a),
        A.outerWidth() < c ? (u = S.scrollHeight > S.offsetHeight || "scroll" == T.css("overflow-y") ? c + v : c,
        P && (S.scrollHeight > S.offsetHeight || "scroll" == T.css("overflow-y")) && (N.width = Ct(u - v)),
        "" !== g && "" === m || Lt(e, 1, "Possible column misalignment", 6)) : u = "100%",
        k.width = Ct(u),
        b.width = Ct(u),
        E && (e.nScrollFoot.style.width = Ct(u)),
        $ || P && (k.height = Ct(L.offsetHeight + v));
        var q = A.outerWidth();
        x[0].style.width = Ct(q),
        w.width = Ct(q);
        var z = A.height() > S.clientHeight || "scroll" == T.css("overflow-y")
          , G = "padding" + (M.bScrollbarLeft ? "Left" : "Right");
        w[G] = z ? v + "px" : "0px",
        E && (j[0].style.width = Ct(q),
        D[0].style.width = Ct(q),
        D[0].style[G] = z ? v + "px" : "0px"),
    ...
    function mt(t, e, n) {
        for (var i, r, o = 0, a = 0, s = e.length; a < s; ) {
            for (i = e[a].firstChild,
            r = n ? n[a].firstChild : null; i; )
                1 === i.nodeType && (n ? t(i, r, o) : t(i, o),
                o++),
                i = i.nextSibling,
    ...
    function $t(n) {
        var i, r, o, a = n.nTable, s = n.aoColumns, d = n.oScroll, l = d.sY, u = d.sX, c = d.sXInner, h = s.length, g = $(n, "bVisible"), v = t("th", n.nTHead), y = a.getAttribute("width"), b = a.parentNode, C = !1, w = n.oBrowser, x = w.bScrollOversize, S = a.style.width;
        for (S && S.indexOf("%") !== -1 && (y = S),
        i = 0; i < g.length; i++)
            r = s[g[i]],
            null !== r.sWidth && (r.sWidth = vt(r.sWidthOrig, b),
            C = !0);
        if (x || !C && !u && !l && h == m(n) && h == v.length)
            ...
            for (k.find("thead, tfoot").remove(),
            k.append(t(n.nTHead).clone()).append(t(n.nTFoot).clone()),
            k.find("tfoot th, tfoot td").css("width", ""),
            v = B(n, k.find("thead")[0]),
            i = 0; i < g.length; i++)
                r = s[g[i]],
            ...
            if (n.aoData.length)
                for (i = 0; i < g.length; i++)
                    o = g[i],
                    r = s[o],
                    t(yt(n, o)).clone(!1).append(r.sContentPadding).appendTo(_);
            ...
            u && c ? k.width(c) : u ? (k.css("width", "auto"),
            k.removeAttr("width"),
            k.width() < b.clientWidth && y && k.width(b.clientWidth)) : l ? k.width(b.clientWidth) : y && k.width(y);
            var j = 0;
            for (i = 0; i < g.length; i++) {
                var I = t(v[i])
    ...
    function wt(e) {
        ...
        n = 0; n < f.length; n++)
            ...
            o = a.length; r < o; r++)
                s = a[r],
                d = c[s].sType || "string",
                f[n]._idx === i && (f[n]._idx = t.inArray(f[n][1], c[s].asSorting)),
                u.push({
                    src: l,
                    col: s,
                    dir: f[n][1],
    ...
    function xt(t) {
        var e, n, i, r, o, a = [], s = Vt.ext.type.order, d = t.aoData, l = (t.aoColumns,
    ...
    function St(t) {
        for (var e, n, i = t.aoColumns, r = wt(t), o = t.oLanguage.oAria, a = 0, s = i.length; a < s; a++) {
            ...
            d.bSortable ? (r.length > 0 && r[0].col == a ? (c.setAttribute("aria-sort", "asc" == r[0].dir ? "ascending" : "descending"),
            n = l[r[0].index + 1] || l[0]) : n = l[0],
            e = u + ("asc" === n ? o.sSortAscending : o.sSortDescending)) : e = u,
    ...
    function Tt(e, n, r, o) {
        var a, s = e.aoColumns[n], d = e.aaSorting, l = s.asSorting, u = function(e, n) {
            var r = e._idx;
            return r === i && (r = t.inArray(e[1], l)),
            r + 1 < l.length ? r + 1 : n ? null : 0
        };
        if ("number" == typeof d[0] && (d = e.aaSorting = [d]),
        r && e.oFeatures.bSortMulti) {
            var c = t.inArray(n, de(d, "0"));
            c !== -1 ? (a = u(d[c], !0),
            null === a && 1 === d.length && (a = 0),
            null === a ? d.splice(c, 1) : (d[c][1] = l[a],
            d[c]._idx = a)) : (d.push([n, l[0], 0]),
            d[d.length - 1]._idx = 0)
        } else
            d.length && d[0][0] == n ? (a = u(d[0]),
            d.length = 1,
            d[0][1] = l[a],
            d[0]._idx = a) : (d.length = 0,
            d.push([n, l[0]]),
            d[0]._idx = 0);
        O(e),
    ...
    function kt(t, e, n, i) {
        var r = t.aoColumns[n];
        Mt(e, {}, function(e) {
            r.bSortable !== !1 && (t.oFeatures.bProcessing ? (pt(t, !0),
            setTimeout(function() {
                Tt(t, n, e.shiftKey, i),
                "ssp" !== Ft(t) && pt(t, !1)
    ...
    function _t(e) {
        ...
        if (d.bSort && d.bSortClasses) {
            ...
            i = o.length; n < i; n++)
                r = o[n].src,
                t(de(e.aoData, "anCells", r)).removeClass(a + (n < 2 ? n + 1 : 3));
            for (n = 0,
            i = s.length; n < i; n++)
                r = s[n].src,
                t(de(e.aoData, "anCells", r)).addClass(a + (n < 2 ? n + 1 : 3))
        }
        e.aLastSort = s
    }
    function Dt(t, e) {
        ...
        for (var o, a, s = Vt.ext.type.order[i.sType + "-pre"], d = 0, l = t.aoData.length; d < l; d++)
            o = t.aoData[d],
            o._aSortData || (o._aSortData = []),
            o._aSortData[e] && !r || (a = r ? n[d] : S(t, d, e, "sort"),
    ...
    function jt(e) {
        if (e.oFeatures.bStateSave && !e.bDestroying) {
            ...
            Rt(e, "aoStateSaveParams", "stateSaveParams", [e, n]),
            e.oSavedState = n,
            ...
            if (s && s.time) {
                ...
                if (t.inArray(!1, d) === -1) {
                    ...
                    if (!(l > 0 && s.time < +new Date - 1e3 * l) && a.length === s.columns.length) {
                        for (e.oLoadedState = t.extend(!0, {}, s),
                        s.start !== i && (e._iDisplayStart = s.start,
                        e.iInitDisplayStart = s.start),
                        s.length !== i && (e._iDisplayLength = s.length),
                        s.order !== i && (e.aaSorting = [],
                        t.each(s.order, function(t, n) {
                            e.aaSorting.push(n[0] >= a.length ? [0, n[1]] : n)
                        })),
                        s.search !== i && t.extend(e.oPreviousSearch, nt(s.search)),
                        r = 0,
                        o = s.columns.length; r < o; r++) {
                            var u = s.columns[r];
                            u.visible !== i && (a[r].bVisible = u.visible),
                            u.search !== i && t.extend(e.aoPreSearchCols[r], nt(u.search))
                        }
    ...
    function Lt(t, n, i, r) {
        ...
        n)
            e.console && console.log && console.log(i);
        else {
            var o = Vt.ext
              , a = o.sErrMode || o.errMode;
            if (t && Rt(t, null, "error", [t, r, i]),
            "alert" == a)
                alert(i);
            else {
                if ("throw" == a)
    ...
    function Qt(t, e) {
        var n = []
          , i = Ue.numbers_length
          , r = Math.floor(i / 2);
        return e <= i ? n = ue(0, e) : t <= r ? (n = ue(0, i - 2),
        n.push("ellipsis"),
        n.push(e - 1)) : t >= e - 1 - r ? (n = ue(e - (i - 2), e),
        n.splice(0, 0, "ellipsis"),
        n.splice(0, 0, 0)) : (n = ue(t - r + 2, t + r - 1),
        n.push("ellipsis"),
        n.push(e - 1),
        n.splice(0, 0, "ellipsis"),
        n.splice(0, 0, 0)),
    ...
    var Ut, qt, zt, Gt, Vt = function(e) {
        ...
        this.fnFilter = function(t, e, n, r, o, a) {
            var s = this.api(!0);
            null === e || e === i ? s.search(t, n, r, a) : s.column(e).search(t, n, r, a),
            s.draw()
        }
        ,
        ...
        this.fnUpdate = function(t, e, n, r, o) {
            var a = this.api(!0);
            return n === i || null === n ? a.row(e).data(t) : a.cell(e, n).data(t),
            (o === i || o) && a.columns.adjust(),
            (r === i || r) && a.draw(),
            0
        }
        ,
        ...
        for (var p in Vt.ext.internal)
            p && (this[p] = Wt(p));
        return this.each(function() {
            var p, f = {}, g = u > 1 ? Et(f, e, !0) : e, m = 0, $ = this.getAttribute("id"), v = !1, w = Vt.defaults, x = t(this);
            if ("table" != this.nodeName.toLowerCase())
                return void Lt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            s(w),
            d(w.column),
            o(w, w, !0),
            o(w.column, w.column, !0),
            o(w, t.extend(g, x.data()));
            var S = Vt.settings;
            for (m = 0,
            p = S.length; m < p; m++) {
                var T = S[m];
            ...
            null !== $ && "" !== $ || ($ = "DataTables_Table_" + Vt.ext._unique++,
            this.id = $);
            ...
            j.oInit = g,
            S.push(j),
            j.oInstance = 1 === n.length ? n : x.dataTable(),
            s(g),
            g.oLanguage && a(g.oLanguage),
            g.aLengthMenu && !g.iDisplayLength && (g.iDisplayLength = t.isArray(g.aLengthMenu[0]) ? g.aLengthMenu[0][0] : g.aLengthMenu[0]),
            g = Et(t.extend(!0, {}, w), g),
            Nt(j.oFeatures, g, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]),
            Nt(j, g, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", "rowId", ["iCookieDuration", "iStateDuration"], ["oSearch", "oPreviousSearch"], ["aoSearchCols", "aoPreSearchCols"], ["iDisplayLength", "_iDisplayLength"], ["bJQueryUI", "bJUI"]]),
            Nt(j.oScroll, g, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]),
            Nt(j.oLanguage, g, "fnInfoCallback"),
            Pt(j, "aoDrawCallback", g.fnDrawCallback, "user"),
            Pt(j, "aoServerParams", g.fnServerParams, "user"),
            Pt(j, "aoStateSaveParams", g.fnStateSaveParams, "user"),
            Pt(j, "aoStateLoadParams", g.fnStateLoadParams, "user"),
            Pt(j, "aoStateLoaded", g.fnStateLoaded, "user"),
            Pt(j, "aoRowCallback", g.fnRowCallback, "user"),
            Pt(j, "aoRowCreatedCallback", g.fnCreatedRow, "user"),
            Pt(j, "aoHeaderCallback", g.fnHeaderCallback, "user"),
            Pt(j, "aoFooterCallback", g.fnFooterCallback, "user"),
            Pt(j, "aoInitComplete", g.fnInitComplete, "user"),
            Pt(j, "aoPreDrawCallback", g.fnPreDrawCallback, "user"),
            j.rowIdFn = _(g.rowId),
            l(j);
            var I = j.oClasses;
            if (g.bJQueryUI ? (t.extend(I, Vt.ext.oJUIClasses, g.oClasses),
            g.sDom === w.sDom && "lfrtip" === w.sDom && (j.sDom = '<"H"lfr>t<"F"ip>'),
            j.renderer ? t.isPlainObject(j.renderer) && !j.renderer.header && (j.renderer.header = "jqueryui") : j.renderer = "jqueryui") : t.extend(I, Vt.ext.classes, g.oClasses),
            x.addClass(I.sTable),
            j.iInitDisplayStart === i && (j.iInitDisplayStart = g.iDisplayStart,
            j._iDisplayStart = g.iDisplayStart),
            null !== g.iDeferLoading) {
                j.bDeferLoading = !0;
                var A = t.isArray(g.iDeferLoading);
                j._iRecordsDisplay = A ? g.iDeferLoading[0] : g.iDeferLoading,
                j._iRecordsTotal = A ? g.iDeferLoading[1] : g.iDeferLoading
            }
            var L = j.oLanguage;
            t.extend(!0, L, g.oLanguage),
            "" !== L.sUrl && (t.ajax({
                dataType: "json",
                url: L.sUrl,
                success: function(e) {
            ...
            v = !0),
            null === g.asStripeClasses && (j.asStripeClasses = [I.sStripeOdd, I.sStripeEven]);
            var N = j.asStripeClasses
              , E = x.children("tbody").find("tr").eq(0);
            t.inArray(!0, t.map(N, function(t, e) {
                return E.hasClass(t)
            })) !== -1 && (t("tbody tr", this).removeClass(N.join(" ")),
            j.asDestroyStripes = N.slice());
            var M, P = [], R = this.getElementsByTagName("thead");
            if (0 !== R.length && (Q(j.aoHeader, R[0]),
            P = B(j)),
            null === g.aoColumns)
                for (M = [],
                m = 0,
            ...
            var O = j.oFeatures;
            if (g.bStateSave && (O.bStateSave = !0,
            It(j, g),
            Pt(j, "aoDrawCallback", jt, "state_save")),
            g.aaSorting === i) {
                var F = j.aaSorting;
                for (m = 0,
                p = F.length; m < p; m++)
                    F[m][1] = j.aoColumns[m].asSorting[0]
            }
            _t(j),
            O.bSort && Pt(j, "aoDrawCallback", function() {
                if (j.bSorted) {
                    var e = wt(j)
                      , n = {};
            ...
            var W = x.children("caption").each(function() {
              ...
              , U = x.children("thead");
            0 === U.length && (U = t("<thead/>").appendTo(this)),
            j.nTHead = U[0];
            var q = x.children("tbody");
            0 === q.length && (q = t("<tbody/>").appendTo(this)),
            j.nTBody = q[0];
            var z = x.children("tfoot");
            if (0 === z.length && W.length > 0 && ("" !== j.oScroll.sX || "" !== j.oScroll.sY) && (z = t("<tfoot/>").appendTo(this)),
            0 === z.length || 0 === z.children().length ? x.addClass(I.sNoFooter) : z.length > 0 && (j.nTFoot = z[0],
            Q(j.aoFooter, j.nTFoot)),
            g.aaData)
                for (m = 0; m < g.aaData.length; m++)
                    b(j, g.aaData[m]);
            else
                (j.bDeferLoading || "dom" == Ft(j)) && C(j, t(j.nTBody).children("tr"));
            j.aiDisplay = j.aiDisplayMaster.slice(),
            j.bInitialised = !0,
            v === !1 && at(j)
        }),
        n = null,
        ...
        return Kt[e] || (Kt[e] = new RegExp($e(e),"g")),
        "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(Kt[e], ".") : t
    }, oe = function(t, e, n) {
        var i = "string" == typeof t;
        return !!ne(t) || (e && i && (t = re(t, e)),
        n && i && (t = t.replace(ee, "")),
        ...
        iterator: function(t, e, n, r) {
            ...
            s = f.length; a < s; a++) {
                ...
                if ("table" === e)
                    ...
                    o = n.call(m, f[a], this[a], a),
                    o !== i && p.push(o);
                else if ("column" === e || "column-rows" === e || "row" === e || "cell" === e)
                    for (c = this[a],
                    "column-rows" === e && (u = Ie(f[a], g.opts)),
                    d = 0,
                    l = c.length; d < l; d++)
                        h = c[d],
                        o = "cell" === e ? n.call(m, f[a], h.row, h.column, a, d) : n.call(m, f[a], h, a, d, u),
                        o !== i && p.push(o)
            }
            if (p.length || r) {
                var $ = new qt(f,t ? p.concat.apply([], p) : p)
                  , v = $.selector;
                return v.rows = g.rows,
                v.cols = g.cols,
                v.opts = g.opts,
                $
            }
    ...
    qt.extend = function(e, n, i) {
        if (i.length && n && (n instanceof qt || n.__dt_wrapper)) {
            ...
            o = i.length; r < o; r++)
                a = i[r],
                n[a.name] = "function" == typeof a.val ? s(e, a.val, a) : t.isPlainObject(a.val) ? {} : a.val,
                n[a.name].__dt_wrapper = !0,
                qt.extend(e, n[a.name], a.propExt)
        }
    }
    ,
    qt.register = zt = function(e, n) {
        if (t.isArray(e))
            ...
            a = l.length; o < a; o++) {
                ...
                u.push(h)),
                o === a - 1 ? h.val = n : u = d ? h.methodExt : h.propExt
            }
        }
    }
    ,
    ...
    zt("draw()", function(t) {
        return this.iterator("table", function(e) {
            "page" === t ? H(e) : ("string" == typeof t && (t = "full-hold" !== t),
            O(e, t === !1))
        })
    }),
    zt("page()", function(t) {
    ...
    var ke = function(t, e, n) {
        ...
        if ("ssp" == Ft(t))
            ...
            W(t, [], function(n) {
                I(t);
                for (var i = G(t, n), r = 0, o = i.length; r < o; r++)
                    b(t, i[r]);
                O(t, e),
                pt(t, !1)
            })
    ...
    var _e = function(e, n, r, o, a) {
        ...
        for (n && "string" !== f && "function" !== f && n.length !== i || (n = [n]),
        l = 0,
        u = n.length; l < u; l++)
            for (d = n[l] && n[l].split ? n[l].split(",") : [n[l]],
            c = 0,
            h = d.length; c < h; c++)
                s = r("string" == typeof d[c] ? t.trim(d[c]) : d[c]),
      ...
      , Ie = function(e, n) {
        ...
        if ("ssp" == Ft(e))
            return "removed" === l ? [] : ue(0, d.length);
        if ("current" == c)
            for (i = e._iDisplayStart,
            r = e.fnDisplayEnd(); i < r; i++)
                a.push(s[i]);
        else if ("current" == u || "applied" == u)
            a = "none" == l ? d.slice() : "applied" == l ? s.slice() : t.map(d, function(e, n) {
                return t.inArray(e, s) === -1 ? e : null
            });
        else if ("index" == u || "original" == u)
            for (i = 0,
            r = e.aoData.length; i < r; i++)
                "none" == l ? a.push(i) : (o = t.inArray(i, s),
    ...
    zt("rows.add()", function(e) {
        var n = this.iterator("table", function(t) {
            ...
            r = e.length; i < r; i++)
                n = e[i],
                n.nodeName && "TR" === n.nodeName.toUpperCase() ? o.push(C(t, n)[0]) : o.push(b(t, n));
            return o
        }, 1)
          , i = this.rows(-1);
        return i.pop(),
    ...
    var Le = function(e, n, i, r) {
        var o = []
          , a = function(n, i) {
            if (t.isArray(n) || n instanceof t)
                ...
                t("td", d).addClass(i).html(n)[0].colSpan = m(e),
                o.push(d[0])
            }
        };
        a(i, r),
        n._details && n._details.remove(),
        n._details = t(o),
      ...
      , Ee = function(t, e) {
        ...
        if (n.length && t.length) {
            ...
            i._details && (i._detailsShow = e,
            e ? i._details.insertAfter(i.nTr) : i._details.detach(),
            Me(n[0]))
        }
    }
      , Me = function(t) {
        var e = new qt(t)
          ...
          , a = t.aoData;
        e.off(i + " " + r + " " + o),
        de(a, "_details").length > 0 && (e.on(i, function(n, i) {
            t === i && e.rows({
                page: "current"
        ...
        e.on(r, function(e, n, i, r) {
            if (t === n)
                for (var o, s = m(n), d = 0, l = a.length; d < l; d++)
                    o = a[d],
                    o._details && o._details.children("td[colspan]").attr("colspan", s)
        }),
        e.on(o, function(n, i) {
            if (t === i)
        ...
        if (u.bVisible !== r) {
            if (r) {
                ...
                s = c.length; a < s; a++)
                    d = c[a].nTr,
                    o = c[a].anCells,
                    d && d.insertBefore(o[n], o[h] || null)
            } else
                t(de(e.aoData, "anCells", n)).detach();
            u.bVisible = r,
            R(e, e.aoHeader),
            R(e, e.aoFooter),
            jt(e)
    ...
    var We = function(e, n, r) {
        var o, a, s, d, l, u, c, h = e.aoData, p = Ie(e, r), f = ce(le(h, p, "anCells")), g = t([].concat.apply([], f)), m = e.aoColumns.length, $ = function(n) {
            ...
            if (null === n || n === i || r) {
                ...
                d = p.length; s < d; s++)
                    ...
                    l = 0; l < m; l++)
                        ...
                        r ? (c = h[o],
                        n(u, S(e, o, l), c.anCells ? c.anCells[l] : null) && a.push(u)) : a.push(u);
                return a
            }
            ...
            return f.length || !n.nodeName ? f : (c = t(n).closest("*[data-dt-row]"),
            c.length ? [{
                row: c.data("dt-row"),
    ...
    zt("cells()", function(e, n, r) {
        if (t.isPlainObject(e) && (e.row === i ? (r = e,
        e = null) : (r = n,
        n = null)),
    ...
    zt("destroy()", function(n) {
        ...
        this.iterator("table", function(i) {
            ...
            i.bDestroying = !0,
            Rt(i, "aoDestroyCallback", "destroy", [i]),
            n || new qt(i).columns().visible(!0),
            p.unbind(".DT").find(":not(tbody *)").unbind(".DT"),
            t(e).unbind(".DT-" + i.sInstance),
            s != l.parentNode && (c.children("thead").detach(),
            c.append(l)),
            u && s != u.parentNode && (c.children("tfoot").detach(),
            c.append(u)),
            i.aaSorting = [],
            i.aaSortingFixed = [],
            _t(i),
            t(f).removeClass(i.asStripeClasses.join(" ")),
            ...
            c[g](),
            p[g](),
            !n && o && (o.insertBefore(s, i.nTableReinsertBefore),
            c.css("width", i.sDestroyWidth).removeClass(a.sTable),
            r = i.asDestroyStripes.length,
            r && h.children().each(function(e) {
    ...
    zt("i18n()", function(e, n, r) {
        var o = this.context[0]
          , a = _(e)(o.oLanguage);
        return a === i && (a = n),
        r !== i && t.isPlainObject(a) && (a = a[r] !== i ? a[r] : a._),
        a.replace("%d", r)
    }),
    Vt.version = "1.10.12",
    Vt.settings = [],
    ...
    t.extend(!0, Vt.ext.renderer, {
        pageButton: {
            _: function(e, i, r, o, a, s) {
                ...
                g(t(i).empty(), o),
                u && t(i).find("[data-dt-idx=" + u + "]").focus()
            }
        }
    }),
    ...
    , function(t, e) {
        if (t && !(t instanceof Date) && (!Yt.test(t) || !Zt.test(t)))
            return null;
        var n = Date.parse(t);
    ...
    t.fn.dataTable = Vt,
    Vt.$ = t,
    t.fn.dataTableSettings = Vt.settings,
    t.fn.dataTableExt = Vt.ext,
...
function(t) {
    ...
    r.ext.renderer.pageButton.bootstrap = function(e, i, o, a, s, d) {
        var l, u, c, h = new r.Api(e), p = e.oClasses, f = e.oLanguage.oPaginate, g = e.oLanguage.oAria.paginate || {}, m = 0, $ = function(n, i) {
        ...
        $(t(i).empty().html('<ul class="pagination"/>').children("ul"), a),
        c && t(i).find("[data-dt-idx=" + c + "]").focus()
    }
    ,
    r
}),
function(t) {
    ...
    var r = t.fn.dataTable
      , o = function(e, n) {
        if (!r.versionCheck || !r.versionCheck("1.10.3"))
        ...
        this.c = t.extend(!0, {}, o.defaults, r.defaults.responsive, n),
        e.responsive = this,
        this._constructor())
    };
    t.extend(o.prototype, {
        _constructor: function() {
            ...
            t(e).on("resize.dtr orientationchange.dtr", r.util.throttle(function() {
                var i = t(e).width();
                i !== a && (n._resize(),
                a = i)
            })),
            ...
            s.type !== !1 && (n._detailsInit(),
            i.on("column-visibility.dtr", function(t, e, i, r) {
                n._classLogic(),
                n._resizeAuto(),
                n._resize()
            }),
            ...
            t(i.table().node()).addClass("dtr-" + s.type)),
            i.on("column-reorder.dtr", function(t, e, i) {
                n._classLogic(),
                n._resizeAuto(),
                n._resize()
            }),
            ...
            i.on("init.dtr", function(e, r, o) {
                n._resizeAuto(),
                n._resize(),
                t.inArray(!1, n.s.current) && i.columns.adjust()
            }),
            this._resize()
        },
        ...
        _classLogic: function() {
            var e = this
              ...
              , s = function(t, i, r, s) {
                ...
                if (r) {
                    if ("max-" === r)
                        for (d = e._find(i).width,
                        l = 0,
                        u = n.length; l < u; l++)
                            n[l].width <= d && a(t, n[l].name);
                    else if ("min-" === r)
                        for (d = e._find(i).width,
                        l = 0,
                        u = n.length; l < u; l++)
                        ...
                        for (l = 0,
                        u = n.length; l < u; l++)
                            n[l].name.indexOf(s) === -1 && a(t, n[l].name)
                } else
                    o[t].includeIn.push(i)
            };
            o.each(function(e, i) {
                for (var r = e.className.split(" "), o = !1, a = 0, d = r.length; a < d; a++) {
                    ...
                    t.each(n, function(t, e) {
                        var n = e.name.split("-")
                          ...
                          , a = l.match(r);
                        a && (o = !0,
                        a[2] === n[0] && a[3] === "-" + n[1] ? s(i, e.name, a[1], a[2] + a[3]) : a[2] !== n[0] || a[3] || s(i, e.name, a[1], a[2]))
                    })
                }
                o || (e.auto = !0)
            }),
        ...
        _resize: function() {
            ...
            o.columns().eq(0).each(function(t, e) {
                c[e] !== u[e] && (p = !0,
                r._setColumnVis(t, c[e]))
            }),
            p && (this._redrawChildren(),
            t(o.table().node()).trigger("responsive-resize.dt", [o, this.s.current]))
        },
        _resizeAuto: function() {
            ...
            if (this.c.auto && t.inArray(!0, t.map(n, function(t) {
                ...
                "inline" === this.c.details.type && t(i).addClass("dtr-inline collapsed"),
        ...
        _setColumnVis: function(e, n) {
            ...
            t(i.column(e).footer()).css("display", r),
    ...
    o.display = {
        childRow: function(e, n, i) {
            return n ? t(e.node()).hasClass("parent") ? (e.child(i(), "child").show(),
            !0) : void 0 : e.child.isShown() ? (e.child(!1),
            t(e.node()).removeClass("parent"),
            !1) : (e.child(i(), "child").show(),
            t(e.node()).addClass("parent"),
            !0)
        },
        childRowImmediate: function(e, n, i) {
            return !n && e.child.isShown() || !e.responsive.hasHidden() ? (e.child(!1),
            t(e.node()).removeClass("parent"),
            !1) : (e.child(i(), "child").show(),
            t(e.node()).addClass("parent"),
            !0)
        ...
        modal: function(e) {
            return function(i, r, o) {
                if (r)
                    t("div.dtr-modal-content").empty().append(o());
                else {
                    var a = function() {
                        s.remove(),
...
function(t) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-bs", "datatables.net-responsive"], function(e) {
        ...
        return e || (e = window),
        n && n.fn.dataTable || (n = require("datatables.net-bs")(e, n).$),
...
!function(t) {
    ...
    function n(e, n) {
        this.$select = t(e),
        this.$select.attr("data-placeholder") && (n.nonSelectedText = this.$select.data("placeholder")),
        this.options = this.mergeOptions(t.extend({}, n, this.$select.data())),
    ...
    n.prototype = {
        defaults: {
            buttonText: function(e, n) {
                ...
                if (this.allSelectedText && e.length === t("option", t(n)).length && 1 !== t("option", t(n)).length && this.multiple)
        ...
        buildDropdownOptions: function() {
            ...
            t("li input", this.$ul).on("change", t.proxy(function(e) {
                ...
                if (r && (i ? this.selectAll() : this.deselectAll()),
                r || (i ? (a.prop("selected", !0),
                this.options.multiple ? a.prop("selected", !0) : (this.options.selectedClass && t(d).closest("li").removeClass(this.options.selectedClass),
                t(d).prop("checked", !1),
                s.prop("selected", !1),
                this.$button.click()),
                "active" === this.options.selectedClass && s.closest("a").css("outline", "")) : a.prop("selected", !1)),
                this.$select.change(),
                this.updateButtonText(),
                this.updateSelectAll(),
                this.options.onChange(a, i),
            ...
            t("li a", this.$ul).on("touchstart click", t.proxy(function(e) {
                ...
                if (e.shiftKey && this.options.multiple) {
                    ...
                    if (null !== this.lastToggledInput && this.lastToggledInput !== n) {
                        ...
                        s.prop("checked", i),
                        this.options.selectedClass && s.closest("li").toggleClass(this.options.selectedClass, i);
        ...
        createOptionValue: function(e) {
            ...
            var i = this.options.optionLabel(e)
              ...
              , s = t("label", a);
            s.addClass(o),
            this.options.enableHTML ? s.html(" " + i) : s.text(" " + i);
            var d = t("<input/>").attr("type", o);
            this.options.checkboxName && d.attr("name", this.options.checkboxName),
            s.prepend(d);
            var l = n.prop("selected") || !1;
            d.val(r),
            r === this.options.selectAllValue && (a.addClass("multiselect-item multiselect-all"),
            d.parent().parent().addClass("multiselect-all")),
            s.attr("title", n.attr("title")),
            this.$ul.append(a),
            n.is(":disabled") && d.attr("disabled", "disabled").prop("disabled", !0).closest("a").attr("tabindex", "-1").closest("li").addClass("disabled"),
            d.prop("checked", l),
            l && this.options.selectedClass && d.closest("li").addClass(this.options.selectedClass)
        },
        ...
        createOptgroup: function(e) {
            ...
            this.options.enableHTML ? t("label", i).html(n) : t("label", i).text(n),
            this.options.enableClickableOptGroups && i.addClass("multiselect-group-clickable"),
            this.$ul.append(i),
            t(e).is(":disabled") && i.addClass("disabled"),
        ...
        buildSelectAll: function() {
            ...
            if (!e && this.options.includeSelectAllOption && this.options.multiple && t("option", this.$select).length > this.options.includeSelectAllIfMoreThan) {
                ...
                t("label", n).addClass("checkbox"),
                this.options.enableHTML ? t("label", n).html(" " + this.options.selectAllText) : t("label", n).text(" " + this.options.selectAllText),
                            ...
                            if (this.query !== e.target.value) {
                                ...
                                t.each(t("li", this.$ul), t.proxy(function(e, r) {
                                    ...
                                    o !== this.options.selectAllValue && a) {
                                        ...
                                        t(r).toggle(d).toggleClass("filter-hidden", !d),
                                        t(r).hasClass("multiselect-group") ? (n = r,
                                        i = d) : (d && t(n).show().removeClass("filter-hidden"),
                                        !d && i && t(r).show().removeClass("filter-hidden"))
                                    }
                                }, this))
                            }
                            this.updateSelectAll()
        ...
        refresh: function() {
            t("option", this.$select).each(t.proxy(function(e, n) {
                ...
                this.options.selectedClass && i.closest("li").addClass(this.options.selectedClass)) : (i.prop("checked", !1),
        ...
        selectAll: function(e, n) {
            ...
            o === a || e === !1)
                t("option:enabled", this.$select).prop("selected", !0);
            else {
        ...
        updateSelectAll: function() {
            if (this.hasSelectAll()) {
                var e = t("li:not(.multiselect-item):not(.filter-hidden) input:enabled", this.$ul)
                  ...
                  , o = r.find("input");
                i > 0 && i === n ? (o.prop("checked", !0),
                r.addClass(this.options.selectedClass),
                this.options.onSelectAll()) : (o.prop("checked", !1),
                r.removeClass(this.options.selectedClass))
            }
        },
    ...
    t.fn.multiselect = function(e, i, r) {
        return this.each(function() {
            ...
            "string" == typeof e && (o[e](i, r),
            "destroy" === e && t(this).data("multiselect", !1))
        })
    }
    ,
    t.fn.multiselect.Constructor = n,
    t(function() {
    ...
    r.prototype = {
        ...
        _appendListItems: function(t, e) {
            for (var n = "", i = 0; i < t.length; i++) {
                ...
                n += "<span class='country-name'>" + r.name + "</span>",
                n += "<span class='dial-code'>+" + r.dialCode + "</span>",
                n += "</li>"
            }
        ...
        _initDropdownListeners: function() {
            ...
            this.flagsContainer.on("keydown" + t.ns, function(e) {
                ...
                e.stopPropagation(),
                t._showDropdown()),
                e.which == d.TAB && t._closeDropdown()
            })
        },
        ...
        _setDropdownPosition: function() {
            ...
            !this.isMobile) {
                ...
                if (this.countryList.toggleClass("dropup", !a && s),
        ...
        _bindDropdownListeners: function() {
            ...
            t(n).on("keydown" + this.ns, function(t) {
                t.preventDefault(),
                t.which == d.UP || t.which == d.DOWN ? e._handleUpDownKey(t.which) : t.which == d.ENTER ? e._handleEnterKey() : t.which == d.ESC ? e._closeDropdown() : (t.which >= d.A && t.which <= d.Z || t.which == d.SPACE) && (o && clearTimeout(o),
                r += String.fromCharCode(t.which),
                e._searchForCountry(r),
        ...
        _handleUpDownKey: function(t) {
            ...
            n.length && (n.hasClass("divider") && (n = t == d.UP ? n.prev() : n.next()),
        ...
        _updateFlagFromNumber: function(e) {
            ...
            if (n) {
                ...
                "+" == e.charAt(0) && r.length ? i = "" : e && "+" != e || (i = this.defaultCountry);
        ...
        _setFlag: function(t) {
            ...
            this.options.separateDialCode) {
                ...
                e.dialCode && r.removeClass("iti-sdc-" + (e.dialCode.length + 1)),
                i && r.addClass("iti-sdc-" + i.length),
...
function() {
    ...
    function e(t, e) {
        ...
        n.length || void 0 === e ? i = i[r] ? i[r] : i[r] = {} : i[r] = e
    }
    function n(t, e) {
        function n() {}
    ...
    function _(t) {
        var e = t.search(Tt);
        return 0 <= e ? (t = t.substring(e),
        t = t.replace(_t, ""),
        e = t.search(kt),
        0 <= e && (t = t.substring(0, e))) : t = "",
        t
    }
    function D(t) {
    ...
    function L(t, e) {
        for (var n, i = new C, r = t.length, o = 0; o < r; ++o)
            n = t.charAt(o),
            n = e[n.toUpperCase()],
            null != n && i.a(n);
        return i.toString()
    ...
    function E(t, e, n) {
        ...
        if (!(i in yt))
            return r;
        t = M(t, i, W(i)),
        e = null != e.a[3] && h(e, 3).length ? 3 == n ? ";ext=" + h(e, 3) : null != t.a[13] ? h(t, 13) + p(e, 3) : " ext. " + p(e, 3) : "";
        t: {
            t = f(t, 20).length && 2 != n ? f(t, 20) : f(t, 19);
            for (var o, a = t.length, s = 0; s < a; ++s) {
                o = t[s];
                var d = g(o, 3);
                if ((!d || !r.search(h(o, 3, d - 1))) && (d = new RegExp(h(o, 1)),
                K(d, r))) {
                    t = o;
                    break t
                }
        ...
        p(a, 5),
        a = p(a, 4),
        r = 2 == n && null != a && 0 < a.length ? r.replace(o, t.replace(At, a)) : r.replace(o, t),
        3 == n && (r = r.replace(RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""),
        r = r.replace(RegExp("[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-"))),
        R(i, n, r, e)
    }
    function M(t, e, n) {
    ...
    function U(t, e, n, r) {
        ...
        if (2 == r) {
            if (!A(H(n, 0)))
                return U(t, e, n, 1);
            t = H(n, 1),
            A(t) && (a = a.concat(g(t, 9) ? f(t, 9) : f(h(n, 1), 9)),
            i(a),
            o.length ? (o = o.concat(f(t, 10)),
            i(o)) : o = f(t, 10))
        }
        return -1 == a[0] ? 5 : (e = e.length,
        -1 < ot(o, e) ? 4 : (n = a[0],
        n == e ? 0 : n > e ? 2 : a[a.length - 1] < e ? 3 : -1 < ot(a, e, 1) ? 0 : 5))
    }
    function q(t, e, n, i, r, o) {
        ...
        20 != a) {
            ...
            t: {
                ...
                t.length && "0" != t.charAt(0))
                    for (r = t.length,
                    e = 1; 3 >= e && e <= r; ++e)
                        if (n = parseInt(t.substring(0, e), 10),
                        n in yt) {
                            i.a(t.substring(e)),
                            i = n;
                            break t
        ...
        s = "" + a,
        d = e.toString(),
        !d.lastIndexOf(s, 0) && (s = new C(d.substring(s.length)),
        d = h(n, 1),
        d = new RegExp(p(d, 2)),
        z(s, n, null),
        s = s.toString(),
        !K(d, e.toString()) && K(d, s) || 3 == U(t, e.toString(), n, -1))) ? (i.a(s),
        r && m(o, 6, 10),
        m(o, 1, a),
        a) : (m(o, 1, 0),
        0)
        ...
        if (r && null != o && o.length) {
            ...
            if (r = a.exec(i)) {
                var o = new RegExp(p(h(e, 1), 2))
                  ...
                  , d = r.length - 1;
                e = h(e, 16),
                null != e && e.length && null != r[d] && r[d].length ? (i = i.replace(a, e),
                (!s || K(o, i)) && (n && 0 < d && n.a(r[1]),
                t.set(i))) : s && !K(o, i.substring(r[0].length)) || (n && 0 < d && null != r[d] && n.a(r[1]),
                t.set(i.substring(r[0].length)))
            }
        }
    }
    function G(t, e, n) {
        if (!N(n) && 0 < e.length && "+" != e.charAt(0))
            throw Error("Invalid country calling code");
        return V(t, e, n, !0)
    }
    function V(t, e, n, i) {
        ...
        !D(r.toString()))
            throw Error("The string supplied did not seem to be a phone number");
        if (o = r.toString(),
        !(N(n) || null != o && 0 < o.length && xt.test(o)))
            throw Error("Invalid country calling code");
        o = new T,
        i && m(o, 5, e);
        t: {
        ...
        try {
            ...
            if ("Invalid country calling code" != n.message || !xt.test(d))
                throw n;
            if (d = d.replace(xt, ""),
            s = q(t, d, a, e, i, o),
            !s)
        ...
        r = new C(e.toString()),
        z(r, a, n),
        t = U(t, r.toString(), a, -1),
        2 != t && 4 != t && 5 != t && (e = r,
        i && 0 < n.toString().length && m(o, 7, n.toString()))),
        i = e.toString(),
        t = i.length,
        2 > t)
            throw Error("The string supplied is too short to be a phone number");
        ...
        if (1 < i.length && "0" == i.charAt(0)) {
            for (m(o, 4, !0),
            t = 1; t < i.length - 1 && "0" == i.charAt(t); )
                t++;
            1 != t && m(o, 8, t)
        }
        return m(o, 2, parseInt(i, 10)),
        o
    }
    function K(t, e) {
    ...
    : function(e, n, i) {
        ...
        t(e))
            return t(n) && 1 == n.length ? e.indexOf(n, i) : -1;
        for (; i < e.length; i++)
            if (i in e && e[i] === n)
                return i;
        return -1
    ...
    v.prototype.a = function(e, n) {
        if (11 == e.b || 10 == e.b)
            return n instanceof l ? n : this.b(e.m.prototype.f(), n);
        if (14 == e.b) {
            if (t(n) && pt.test(n)) {
                var i = Number(n);
                if (0 < i)
        ...
        i === String) {
            if ("number" == typeof n)
                return String(n)
        } else if (i === Number && t(n) && ("Infinity" === n || "-Infinity" === n || "NaN" === n || pt.test(n)))
            return Number(n);
        return n
    }
    ;
    ...
    var Ct = {
      ...
      , At = /(\$\d)/;
    e("intlTelInputUtils", {}),
    e("intlTelInputUtils.formatNumber", function(t, e, n) {
        try {
            var i = k.a()
              , r = G(i, t, e);
    ...
    if (jQuery("body").data("phone-cc-input")) {
        ...
        if (t.length) {
            var e = jQuery('[name^="country"], [name$="country"]')
              , n = "us";
            e.length && (n = e.val().toLowerCase(),
            "um" === n && (n = "us")),
            t.each(function() {
                var i = jQuery(this)
                  , r = i.attr("name");
                "domaincontactphonenumber" === r && (n = jQuery('[name="domaincontactcountry"]').val().toLowerCase()),
                jQuery(this).before('<input id="populatedCountryCode' + r + '" type="hidden" name="country-calling-code-' + r + '" value="" />'),
                i.intlTelInput({
                ...
                i.on("countrychange", function(t, e) {
                    jQuery("#populatedCountryCode" + r).val(e.dialCode),
                    jQuery(this).val() === "+" + e.dialCode && jQuery(this).val("")
                }),
                i.on("blur keydown", function(t) {
                    if ("blur" === t.type || "keydown" === t.type && 13 === t.keyCode) {
                        var e = jQuery(this).intlTelInput("getNumber")
                          ...
                          , i = "+" + n.dialCode;
                        0 === e.indexOf(i) && (e.match(/\+/g) || []).length > 1 && (e = e.substr(i.length)),
                        jQuery(this).intlTelInput("setNumber", e)
                    }
                }),
                jQuery("#populatedCountryCode" + r).val(i.intlTelInput("getSelectedCountryData").dialCode),
                ...
                i.attr("data-initial-value", $(i).val()),
                i.parents("form").find("input[type=reset]").each(function() {
                    var t = this
                      , e = $(t).parents("form");
                    $(t).data("phone-handler") || ($(t).data("phone-handler", !0),
                    $(t).click(function(t) {
                        return t.stopPropagation(),
                        $(e).trigger("reset"),
                        $(e).find("input[data-initial-value]").each(function() {
                            var t = this;
            ...
            t.parents("div.form-group").find(".field-icon").addClass("hidden").end(),
            t.removeClass("field").addClass("form-control")
        }
        ...
        i.length && jQuery.each(i, function(t, e) {
            ...
            var r = jQuery('[name$="' + i + '][Country]"]')
              , o = r.val().toLowerCase();
            "um" === o && (o = "us"),
            n.before('<input id="populated' + i + 'CountryCode" type="hidden" name="contactdetails[' + i + '][Phone Country Code]" value="" />'),
            n.intlTelInput({
            ...
            n.on("countrychange", function(t, e) {
                jQuery("#populated" + i + "CountryCode").val(e.dialCode),
                jQuery(this).val() === "+" + e.dialCode && jQuery(this).val("")
            }),
